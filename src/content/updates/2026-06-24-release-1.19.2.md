...
[Learn more about Upper Wolfjaw Mountain <nys-icon name="open_in_new"></nys-icon>](https://en.wikipedia.org/wiki/Upper_Wolfjaw_Mountain)
...
## New `<nys-icon>` additions

Two new icons have been added to the default icon library: `schedule` and `location_on`.

{% set preview %}
<nys-icon name="schedule" size="5xl"></nys-icon>
<nys-icon name="location_on" size="5xl"></nys-icon>
{% endset %}
{% set code = preview %}
...
[Robert Chen](https://github.com/novacat35) made sure these icons showed up right on time and in the right spot!


## New `agencySubheading` for `<nys-globalfooter>`
...
[Robert Chen](https://github.com/novacat35) headed this in the right direction.
...
[Emily Gorelik](https://github.com/emilygorelik) closed the gap!
...
[Emily Gorelik](https://github.com/emilygorelik) drew the line on subtlety.
