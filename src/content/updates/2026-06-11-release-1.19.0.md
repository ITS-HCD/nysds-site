...
To migrate to the new `<nys-icon>` libraries, you'll need to ensure your icon files are in the correct location, and you may need to configure the "default" library to point to your icon files. [Learn how to manage your libraries.](/components/icon/#managing-your-library)
