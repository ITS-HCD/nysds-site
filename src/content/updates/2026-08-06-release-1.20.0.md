...
- YYou may notice that external CSS may impact the styles of a few design system components in this release (table and accordion, specifically). You can override the styles yourself to correct anything that doesn't look right. Future releases should resolve these CSS override issues. You can report any style issues in [our GitHub Issue Tracker](https://github.com/ITS-HCD/nysds/issues). 
