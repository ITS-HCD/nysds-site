...
v1.19.3 "reverts" the change to the default library, while continuing to support defining external libraries. [Learn how to implement a custom library in 1.19.3](/components/icon).
