...
<nys-table striped>
  <table>
    ...
    <tr>
      ...
      <td>Fired when the select state changes.</td>
      <td>
        <ul>
          <li><code>id</code> (string): The id of the select.</li>
          <li><code>value</code> (string): The value of the selected option.</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td><code>nys-focus</code></td>
      <td>Fired when the select gains focus.</td>
      <td>—</td>
    </tr>
    <tr>
      <td><code>nys-blur</code></td>
      <td>Fired when the select loses focus.</td>
      <td>—</td>
    </tr>
  </table>
</nys-table>
