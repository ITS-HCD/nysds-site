 ...
 */const y=a=>a??w;var ht=Object.defineProperty,dt=Object.getOwnPropertyDescriptor,D=(a,e,t,o)=>{for(var s=o>1?void 0:o?dt(e,t):e,r=a.length-1,i;r>=0;r--)(i=a[r])&&(s=(o?i(e,t,s):i(s))||s);return o&&s&&ht(e,t,s),s};let yt=0;const E=(h1=class extends g{constructor(){super(...arguments),this.id="",this.heading="",this.icon="",this.dismissible=!1,this.duration=0,this.text="",this.primaryAction="",this.secondaryAction="",this.primaryLabel="Learn more",this.secondaryLabel="Dismiss",this._alertClosed=!1,this._slotHasContent=!0,this._type="base",this._timeoutId=null}get type(){return this._type}set type(e){this._type=h1.VALID_TYPES.includes(e)?e:"base"}get ariaAttributes(){const e=this.type==="danger"||this.type==="emergency"?"alert":this.type==="success"?"status":"region",t=e==="region"?`${this.type} alert`:"";return{role:e,ariaLabel:t}}connectedCallback(){super.connectedCallback(),this.id||(this.id=this._generateUniqueId()),this.duration>0&&(this._timeoutId=setTimeout(()=>{this._closeAlert()},this.duration))}disconnectedCallback(){this._timeoutId&&clearTimeout(this._timeoutId),super.disconnectedCallback()}firstUpdated(){this._checkSlotContent()}_generateUniqueId(){return`nys-alert-${Date.now()}-${yt++}`}_getIconName(){return this.icon?this.icon:this._checkAltNaming()}_checkAltNaming(){return this.type==="success"?"check_circle":this.type==="base"?"info":this.type==="danger"?"error":this.type==="emergency"?"emergency_home":this.type}_closeAlert(){this._alertClosed=!0,this.dispatchEvent(new CustomEvent("nys-alertClosed",{detail:{type:this.type,label:this.heading},bubbles:!0,composed:!0}))}async _checkSlotContent(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector("slot");if(e){const o=e.assignedNodes({flatten:!0}).filter(s=>{var r;return s.nodeType===Node.ELEMENT_NODE||s.nodeType===Node.TEXT_NODE&&((r=s.textContent)==null?void 0:r.trim())});await Promise.resolve(),this._slotHasContent=o.length>0}else await Promise.resolve(),this._slotHasContent=!1}render(){var o,s;const{role:e,ariaLabel:t}=this.ariaAttributes;return l`
    ...
    `}},h1.styles=ct,h1.VALID_TYPES=["base","info","success","warning","danger","emergency"],h1);D([n({type:String})],E.prototype,"id",2),D([n({type:String})],E.prototype,"heading",2),D([n({type:String})],E.prototype,"icon",2),D([n({type:Boolean,reflect:!0})],E.prototype,"dismissible",2),D([n({type:Number,reflect:!0})],E.prototype,"duration",2),D([n({type:String})],E.prototype,"text",2),D([n({type:String})],E.prototype,"primaryAction",2),D([n({type:String})],E.prototype,"secondaryAction",2),D([n({type:String})],E.prototype,"primaryLabel",2),D([n({type:String})],E.prototype,"secondaryLabel",2),D([Z()],E.prototype,"_alertClosed",2),D([Z()],E.prototype,"_slotHasContent",2),D([n({reflect:!0})],E.prototype,"type",1);let Le=E;customElements.get("nys-alert")||customElements.define("nys-alert",Le);const ut=_`
  :host {
...
`;var Ct=Object.defineProperty,P1=(a,e,t,o)=>{for(var s=void 0,r=a.length-1,i;r>=0;r--)(i=a[r])&&(s=i(e,t,s)||s);return s&&Ct(e,t,s),s};const se=class se extends g{constructor(){super(),this.position="right",this.visible=!1,this.isMobile=!1,this.forceVisible=!1,this._handleScroll=this._handleScroll.bind(this),this._handleResize=this._handleResize.bind(this),this.mediaQuery=window.matchMedia("(max-width: 480px)")}connectedCallback(){super.connectedCallback(),this.forceVisible=this.hasAttribute("visible"),window.addEventListener("scroll",this._handleScroll),this.mediaQuery.addEventListener("change",this._handleResize),this._handleResize()}disconnectedCallback(){window.removeEventListener("scroll",this._handleScroll),this.mediaQuery.removeEventListener("change",this._handleResize),super.disconnectedCallback()}_handleScroll(){if(this.forceVisible)return;const e=window.innerHeight,t=document.documentElement.scrollHeight;this.visible=t>=e*4&&window.scrollY>e*1.5}_scrollToTop(){window.scrollTo({top:0,behavior:"smooth"})}_handleResize(){this.isMobile=this.mediaQuery.matches}render(){const e=["nys-backtotop",this.position,this.visible?"visible":""].filter(Boolean).join(" ");return l`<nys-button
    ...
    ></nys-button>`}};se.styles=vt;let a1=se;P1([n({type:String})],a1.prototype,"position"),P1([n({type:Boolean,reflect:!0})],a1.prototype,"visible"),P1([Z()],a1.prototype,"isMobile"),P1([Z()],a1.prototype,"forceVisible"),customElements.get("nys-backtotop")||customElements.define("nys-backtotop",a1);const _t=_`
  :host {
...
`;var Pt=Object.defineProperty,qt=Object.getOwnPropertyDescriptor,k1=(a,e,t,o)=>{for(var s=o>1?void 0:o?qt(e,t):e,r=a.length-1,i;r>=0;r--)(i=a[r])&&(s=(o?i(e,t,s):i(s))||s);return o&&s&&Pt(e,t,s),s};const C1=(y1=class extends g{constructor(){super(...arguments),this.name="",this.ariaLabel="",this.rotate="0",this.flip="",this.color="",this._size="sm"}get size(){return this._size}set size(e){this._size=y1.VALID_TYPES.includes(e)?e:"sm"}getIcon(){const e=Bt[this.name];if(!e)return null;const s=new DOMParser().parseFromString(e,"image/svg+xml").documentElement;return s instanceof SVGElement?(s.setAttribute("role","img"),this.ariaLabel?(s.setAttribute("aria-label",this.ariaLabel),s.removeAttribute("aria-hidden")):(s.setAttribute("aria-hidden","true"),s.removeAttribute("aria-label")),s.style.rotate=`${this.rotate}deg`,s.style.color=this.color||"currentcolor",s.classList.add(`nys-icon--${this.size}`),s.classList.add("nys-icon--svg"),this.flip&&s.classList.add(`nys-icon--flip-${this.flip}`),s):null}render(){const e=this.getIcon();return e?l`${e}`:null}},y1.styles=Ut,y1.VALID_TYPES=["2xs","xs","sm","md","lg","xl","2xl","3xl","4xl","12","16","24","32","40","48","64"],y1);k1([n({type:String,reflect:!0})],C1.prototype,"name",2),k1([n({type:String})],C1.prototype,"ariaLabel",2),k1([n({type:String})],C1.prototype,"rotate",2),k1([n({type:String})],C1.prototype,"flip",2),k1([n({type:String})],C1.prototype,"color",2),k1([n({reflect:!0})],C1.prototype,"size",1);let ze=C1;customElements.get("nys-icon")||customElements.define("nys-icon",ze);const Ot=_`
  :host {
    /* Label Typography */
...
`;var Tt=Object.defineProperty,Nt=Object.getOwnPropertyDescriptor,U=(a,e,t,o)=>{for(var s=o>1?void 0:o?Nt(e,t):e,r=a.length-1,i;r>=0;r--)(i=a[r])&&(s=(o?i(e,t,s):i(s))||s);return o&&s&&Tt(e,t,s),s};let Ft=0;const A=(t1=class extends g{constructor(){super(),this.id="",this.name="",this.required=!1,this.optional=!1,this.showError=!1,this.errorMessage="",this.label="",this.description="",this.selectedValue=null,this._size="md",this.tile=!1,this._internals=this.attachInternals()}get size(){return this._size}set size(e){this._size=t1.VALID_SIZES.includes(e)?e:"md"}connectedCallback(){super.connectedCallback(),this.id||(this.id=`nys-radiogroup-${Date.now()}-${Ft++}`),this.addEventListener("nys-change",this._handleRadioButtonChange),this.addEventListener("invalid",this._handleInvalid)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("nys-change",this._handleRadioButtonChange),this.removeEventListener("invalid",this._handleInvalid)}firstUpdated(){this._initializeCheckedRadioValue(),this._setValue(),this.setRadioButtonRequire(),this._updateRadioButtonsSize(),this._updateRadioButtonsTile(),this._updateRadioButtonsShowError()}updated(e){(e.has("required")||e.has("selectedValue"))&&this._manageRequire(),e.has("size")&&this._updateRadioButtonsSize(),e.has("tile")&&this._updateRadioButtonsTile(),e.has("showError")&&this._updateRadioButtonsShowError()}formResetCallback(){this.querySelectorAll("nys-radiobutton").forEach(t=>{t.formResetUpdate()})}_setValue(){this._internals.setFormValue(this.selectedValue)}setRadioButtonRequire(){this.querySelectorAll("nys-radiobutton").forEach((t,o)=>{this.required&&o===0&&t.setAttribute("required","required")})}async _manageRequire(){const e=this.errorMessage||"Please select an option.",t=this.querySelector("nys-radiobutton"),o=t?await t.getInputElement():null;o&&(this.required&&!this.selectedValue?this._internals.setValidity({valueMissing:!0},e,o):(this.showError=!1,this._internals.setValidity({},"",o)))}_initializeCheckedRadioValue(){const e=this.querySelector("nys-radiobutton[checked]");e&&(this.selectedValue=e.getAttribute("value"),this._internals.setFormValue(this.selectedValue))}_updateRadioButtonsSize(){this.querySelectorAll("nys-radiobutton").forEach(t=>{t.setAttribute("size",this.size)})}_updateRadioButtonsTile(){this.querySelectorAll("nys-radiobutton").forEach(t=>{this.tile?t.toggleAttribute("tile",!0):t.removeAttribute("tile")})}_updateRadioButtonsShowError(){this.querySelectorAll("nys-radiobutton").forEach(t=>{this.showError?t.setAttribute("showError",""):t.removeAttribute("showError")})}_handleRadioButtonChange(e){const t=e,{name:o,value:s}=t.detail;this.name=o,this.selectedValue=s,this._internals.setFormValue(this.selectedValue)}async _handleInvalid(e){if(e.preventDefault(),this._internals.validity.valueMissing){this.showError=!0,this._manageRequire();const t=this.querySelector("nys-radiobutton"),o=t?await t.getInputElement():null;if(o){const s=this._internals.form;s?Array.from(s.elements).find(c=>{if(c.tagName.toLowerCase()==="nys-radiogroup"){if(!c.querySelector("nys-radiobutton").checkValidity())return c}else return typeof c.checkValidity=="function"&&!c.checkValidity()})===this&&o.focus():o.focus()}}}render(){return l` <div
    ...
    `}},v.VALID_SIZES=["sm","md"],v.buttonGroup={},v.styles=He,v);G([n({type:Boolean,reflect:!0})],P.prototype,"checked",2),G([n({type:Boolean,reflect:!0})],P.prototype,"disabled",2),G([n({type:Boolean,reflect:!0})],P.prototype,"required",2),G([n({type:String})],P.prototype,"label",2),G([n({type:String})],P.prototype,"description",2),G([n({type:String})],P.prototype,"id",2),G([n({type:String,reflect:!0})],P.prototype,"name",2),G([n({type:String})],P.prototype,"value",2),G([n({reflect:!0})],P.prototype,"size",1),G([n({type:Boolean,reflect:!0})],P.prototype,"tile",2);let Ie=P;customElements.get("nys-radiobutton")||customElements.define("nys-radiobutton",Ie);const Wt=_`
  :host {
...
`,L2=`<svg xmlns="http://www.w3.org/2000/svg" width="91" height="55" viewBox="0 0 91 55" fill="none">
  ...
  <path d="M69.4282 52.8659C69.4135 52.8748 69.3891 52.8858 69.3471 52.8858C69.3178 52.8858 69.2837 52.8798 69.27 52.8659L68.9889 52.1476C68.9723 52.1088 68.9459 52.0323 68.944 52.0214C68.944 52.0264 68.9371 52.1277 68.9332 52.1565L68.8815 52.9205C68.8815 52.9205 68.8561 52.9404 68.7858 52.9404C68.7155 52.9404 68.6862 52.9205 68.6862 52.9205L68.7839 51.6787C68.7839 51.6787 68.8112 51.6588 68.8776 51.6588C68.9518 51.6588 68.9781 51.6787 68.9781 51.6787L69.3042 52.5162L69.3471 52.6533C69.3481 52.6473 69.3774 52.5559 69.392 52.5162L69.7181 51.6787C69.7181 51.6787 69.7464 51.6588 69.8206 51.6588C69.886 51.6588 69.9124 51.6787 69.9124 51.6787L70.01 52.9205C70.01 52.9205 69.9807 52.9404 69.9104 52.9404C69.8401 52.9404 69.8167 52.9205 69.8167 52.9205L69.763 52.1546L69.7523 52.0194C69.7523 52.0194 69.722 52.1148 69.7093 52.1456L69.4282 52.8659Z" fill="white"/>
    ...
    `}};he.styles=$2;let R1=he;customElements.get("nys-unavfooter")||customElements.define("nys-unavfooter",R1),f.NysAlert=Le,f.NysAvatar=Se,f.NysBacktotop=a1,f.NysButton=Ee,f.NysCheckbox=Ve,f.NysCheckboxgroup=De,f.NysErrorMessage=g1,f.NysFileinput=$,f.NysGlobalFooter=b1,f.NysGlobalHeader=Q,f.NysIcon=ze,f.NysLabel=l1,f.NysOption=c1,f.NysRadiobutton=Ie,f.NysRadiogroup=Ae,f.NysSelect=Ze,f.NysSkipnav=$1,f.NysTextarea=Ue,f.NysTextinput=Pe,f.NysToggle=qe,f.NysTooltip=W,f.NysUnavFooter=R1,f.NysUnavHeader=O,Object.defineProperty(f,Symbol.toStringTag,{value:"Module"})});
