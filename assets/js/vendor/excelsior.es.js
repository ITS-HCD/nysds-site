import { css as b, LitElement as p, html as a } from "lit";
import { property as l, state as u1 } from "lit/decorators.js";
 ...
 */
const e5 = globalThis, b5 = e5.ShadowRoot && (e5.ShadyCSS === void 0 || e5.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, d2 = Symbol(), A5 = /* @__PURE__ */ new WeakMap();
let Z2 = class {
  constructor(t, e, o) {
    if (this._$cssResult$ = !0, o !== d2) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
  ...
  get styleSheet() {
    ...
    if (b5 && t === void 0) {
      ...
      o && (t = A5.get(e)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), o && A5.set(e, t));
    }
    return t;
  }
  toString() {
...
const H2 = (s) => new Z2(typeof s == "string" ? s : s + "", void 0, d2), V2 = (s, t) => {
  if (b5) s.adoptedStyleSheets = t.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet);
  else for (const e of t) {
    const o = document.createElement("style"), n = e5.litNonce;
    n !== void 0 && o.setAttribute("nonce", n), o.textContent = e.cssText, s.appendChild(o);
  }
}, P5 = b5 ? (s) => s : (s) => s instanceof CSSStyleSheet ? ((t) => {
  let e = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: S2, defineProperty: k2, getOwnPropertyDescriptor: E2, getOwnPropertyNames: z2, getOwnPropertySymbols: A2, getPrototypeOf: P2 } = Object, x1 = globalThis, B5 = x1.trustedTypes, B2 = B5 ? B5.emptyScript : "", O5 = x1.reactiveElementPolyfillSupport, G1 = (s, t) => s, i5 = { toAttribute(s, t) {
  switch (t) {
    case Boolean:
      s = s ? B2 : null;
      break;
  ...
  return e;
} }, _5 = (s, t) => !S2(s, t), U5 = { attribute: !0, type: String, converter: i5, reflect: !1, hasChanged: _5 };
Symbol.metadata ?? (Symbol.metadata = Symbol("metadata")), x1.litPropertyMetadata ?? (x1.litPropertyMetadata = /* @__PURE__ */ new WeakMap());
let O1 = class extends HTMLElement {
  ...
  static createProperty(t, e = U5) {
    if (e.state && (e.attribute = !1), this._$Ei(), this.elementProperties.set(t, e), !e.noAccessor) {
      ...
      n !== void 0 && k2(this.prototype, t, n);
    }
  }
  static getPropertyDescriptor(t, e, o) {
    const { get: n, set: r } = E2(this.prototype, t) ?? { get() {
      return this[e];
    }, set(i) {
      this[e] = i;
    } };
    return { get() {
      ...
      r.call(this, i), this.requestUpdate(t, C, o);
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(G1("properties"))) {
      const e = this.properties, o = [...z2(e), ...A2(e)];
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const n of o) e.unshift(P5(n));
    } else t !== void 0 && e.push(P5(t));
    return e;
  }
  static _$Eu(t, e) {
    const o = e.attribute;
  ...
  createRenderRoot() {
    ...
    return V2(t, this.constructor.elementStyles), t;
  }
  connectedCallback() {
    var t;
  ...
  _$EC(t, e) {
    ...
    if (r !== void 0 && n.reflect === !0) {
      const i = (((o = n.converter) == null ? void 0 : o.toAttribute) !== void 0 ? n.converter : i5).toAttribute(e, n.type);
  ...
  _$AK(t, e) {
    ...
    if (r !== void 0 && this._$Em !== r) {
      const i = n.getPropertyOptions(r), C = typeof i.converter == "function" ? { fromAttribute: i.converter } : ((o = i.converter) == null ? void 0 : o.fromAttribute) !== void 0 ? i.converter : i5;
      this._$Em = r, this[r] = C.fromAttribute(e, i.type), this._$Em = null;
    }
  }
  requestUpdate(t, e, o) {
    if (t !== void 0) {
      if (o ?? (o = this.constructor.getPropertyOptions(t)), !(o.hasChanged ?? _5)(this[t], e)) return;
      this.P(t, e, o);
    }
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (n.size > 0) for (const [r, i] of n) i.wrapped !== !0 || this._$AL.has(r) || this[r] === void 0 || this.P(r, this[r], i);
    }
    let e = !1;
    const o = this._$AL;
    try {
...
O1.elementStyles = [], O1.shadowRootOptions = { mode: "open" }, O1[G1("elementProperties")] = /* @__PURE__ */ new Map(), O1[G1("finalized")] = /* @__PURE__ */ new Map(), O5 == null || O5({ ReactiveElement: O1 }), (x1.reactiveElementVersions ?? (x1.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const O2 = { attribute: !0, type: String, converter: i5, reflect: !1, hasChanged: _5 }, U2 = (s = O2, t, e) => {
  const { kind: o, metadata: n } = e;
  let r = globalThis.litPropertyMetadata.get(n);
  if (r === void 0 && globalThis.litPropertyMetadata.set(n, r = /* @__PURE__ */ new Map()), r.set(e.name, s), o === "accessor") {
    const { name: i } = e;
    return { set(C) {
      const c = t.get.call(this);
      t.set.call(this, C), this.requestUpdate(i, c, s);
    }, init(C) {
      return C !== void 0 && this.P(i, void 0, s), C;
    } };
  }
  if (o === "setter") {
    const { name: i } = e;
    return function(C) {
      const c = this[i];
      t.call(this, C), this.requestUpdate(i, c, s);
    };
  }
  throw Error("Unsupported decorator location: " + o);
};
function V1(s) {
  return (t, e) => typeof e == "object" ? U2(s, t, e) : ((o, n, r) => {
    const i = n.hasOwnProperty(r);
    return n.constructor.createProperty(r, i ? { ...o, wrapped: !0 } : o), i ? Object.getOwnPropertyDescriptor(n, r) : void 0;
  })(s, t, e);
}
const D2 = {
...
`;
var N2 = Object.defineProperty, T2 = Object.getOwnPropertyDescriptor, S1 = (s, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? T2(t, e) : t, r = s.length - 1, i; r >= 0; r--)
    (i = s[r]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && N2(t, e, n), n;
}, U1;
const g1 = (U1 = class extends p {
  constructor() {
  ...
  set size(s) {
    this._size = U1.VALID_TYPES.includes(
      s
    ) ? s : "sm";
  }
  getIcon() {
    const s = D2[this.name], t = !!this.label;
    if (!s) return null;
...
let R2 = g1;
customElements.get("nys-icon") || customElements.define("nys-icon", R2);
/*!
   * 
   * ░█▀▀▀ ▀▄░▄▀ ░█▀▀█ ░█▀▀▀ ░█─── ░█▀▀▀█ ▀█▀ ░█▀▀▀█ ░█▀▀█ 
   * ░█▀▀▀ ─░█── ░█─── ░█▀▀▀ ░█─── ─▀▀▀▄▄ ░█─ ░█──░█ ░█▄▄▀ 
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const o5 = globalThis, w5 = o5.ShadowRoot && (o5.ShadyCSS === void 0 || o5.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, y2 = Symbol(), D5 = /* @__PURE__ */ new WeakMap();
let q2 = class {
  constructor(s, t, e) {
  ...
  get styleSheet() {
    ...
    if (w5 && s === void 0) {
      ...
      e && (s = D5.get(t)), s === void 0 && ((this.o = s = new CSSStyleSheet()).replaceSync(this.cssText), e && D5.set(t, s));
    }
    return s;
  }
  toString() {
...
const j2 = (s) => new q2(typeof s == "string" ? s : s + "", void 0, y2), G2 = (s, t) => {
  if (w5) s.adoptedStyleSheets = t.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet);
  else for (const e of t) {
    const o = document.createElement("style"), n = o5.litNonce;
    n !== void 0 && o.setAttribute("nonce", n), o.textContent = e.cssText, s.appendChild(o);
  }
}, I5 = w5 ? (s) => s : (s) => s instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const o of t.cssRules) e += o.cssText;
  return j2(e);
})(s) : s;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: F2, defineProperty: W2, getOwnPropertyDescriptor: Y2, getOwnPropertyNames: K2, getOwnPropertySymbols: J2, getPrototypeOf: X2 } = Object, L1 = globalThis, N5 = L1.trustedTypes, Q2 = N5 ? N5.emptyScript : "", T5 = L1.reactiveElementPolyfillSupport, F1 = (s, t) => s, l5 = { toAttribute(s, t) {
  switch (t) {
    case Boolean:
      s = s ? Q2 : null;
      break;
  ...
  return e;
} }, m5 = (s, t) => !F2(s, t), R5 = { attribute: !0, type: String, converter: l5, reflect: !1, hasChanged: m5 };
...
let D1 = class extends HTMLElement {
  ...
  static createProperty(t, e = R5) {
    if (e.state && (e.attribute = !1), this._$Ei(), this.elementProperties.set(t, e), !e.noAccessor) {
      const o = Symbol(), n = this.getPropertyDescriptor(t, o, e);
      n !== void 0 && W2(this.prototype, t, n);
    }
  }
  static getPropertyDescriptor(t, e, o) {
    const { get: n, set: r } = Y2(this.prototype, t) ?? { get() {
      return this[e];
    }, set(i) {
      this[e] = i;
    } };
  ...
  static getPropertyOptions(t) {
    return this.elementProperties.get(t) ?? R5;
  }
  static _$Ei() {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(F1("properties"))) {
      const e = this.properties, o = [...K2(e), ...J2(e)];
      for (const n of o) this.createProperty(n, e[n]);
    }
    const t = this[Symbol.metadata];
    if (t !== null) {
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      const o = new Set(t.flat(1 / 0).reverse());
      for (const n of o) e.unshift(I5(n));
  ...
  createRenderRoot() {
    const t = this.shadowRoot ?? this.attachShadow(this.constructor.shadowRootOptions);
    return G2(t, this.constructor.elementStyles), t;
  }
  connectedCallback() {
    var t;
    this.renderRoot ?? (this.renderRoot = this.createRenderRoot()), this.enableUpdating(!0), (t = this._$EO) == null || t.forEach((e) => {
  ...
  _$EC(t, e) {
    ...
    const n = this.constructor.elementProperties.get(t), r = this.constructor._$Eu(t, n);
    if (r !== void 0 && n.reflect === !0) {
      const i = (((o = n.converter) == null ? void 0 : o.toAttribute) !== void 0 ? n.converter : l5).toAttribute(e, n.type);
      this._$Em = t, i == null ? this.removeAttribute(r) : this.setAttribute(r, i), this._$Em = null;
    }
  }
  _$AK(t, e) {
    ...
    const n = this.constructor, r = n._$Eh.get(t);
    if (r !== void 0 && this._$Em !== r) {
      const i = n.getPropertyOptions(r), C = typeof i.converter == "function" ? { fromAttribute: i.converter } : ((o = i.converter) == null ? void 0 : o.fromAttribute) !== void 0 ? i.converter : l5;
      this._$Em = r, this[r] = C.fromAttribute(e, i.type), this._$Em = null;
    }
  }
  requestUpdate(t, e, o) {
    if (t !== void 0) {
      if (o ?? (o = this.constructor.getPropertyOptions(t)), !(o.hasChanged ?? m5)(this[t], e)) return;
      this.P(t, e, o);
    }
    this.isUpdatePending === !1 && (this._$ES = this._$ET());
  }
...
D1.elementStyles = [], D1.shadowRootOptions = { mode: "open" }, D1[F1("elementProperties")] = /* @__PURE__ */ new Map(), D1[F1("finalized")] = /* @__PURE__ */ new Map(), T5 == null || T5({ ReactiveElement: D1 }), (L1.reactiveElementVersions ?? (L1.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const t7 = { attribute: !0, type: String, converter: l5, reflect: !1, hasChanged: m5 }, e7 = (s = t7, t, e) => {
  const { kind: o, metadata: n } = e;
  let r = globalThis.litPropertyMetadata.get(n);
  if (r === void 0 && globalThis.litPropertyMetadata.set(n, r = /* @__PURE__ */ new Map()), r.set(e.name, s), o === "accessor") {
    const { name: i } = e;
...
function H(s) {
  return (t, e) => typeof e == "object" ? e7(s, t, e) : ((o, n, r) => {
    const i = n.hasOwnProperty(r);
    return n.constructor.createProperty(r, i ? { ...o, wrapped: !0 } : o), i ? Object.getOwnPropertyDescriptor(n, r) : void 0;
  })(s, t, e);
}
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const n5 = globalThis, x5 = n5.ShadowRoot && (n5.ShadyCSS === void 0 || n5.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, p2 = Symbol(), q5 = /* @__PURE__ */ new WeakMap();
let n7 = class {
  constructor(s, t, e) {
    if (this._$cssResult$ = !0, e !== p2) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
    this.cssText = s, this.t = t;
  }
  get styleSheet() {
    let s = this.o;
    ...
    if (x5 && s === void 0) {
      const e = t !== void 0 && t.length === 1;
      e && (s = q5.get(t)), s === void 0 && ((this.o = s = new CSSStyleSheet()).replaceSync(this.cssText), e && q5.set(t, s));
    }
    return s;
  }
  toString() {
...
const s7 = (s) => new n7(typeof s == "string" ? s : s + "", void 0, p2), r7 = (s, t) => {
  if (x5) s.adoptedStyleSheets = t.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet);
  else for (const e of t) {
    const o = document.createElement("style"), n = n5.litNonce;
    n !== void 0 && o.setAttribute("nonce", n), o.textContent = e.cssText, s.appendChild(o);
  }
}, j5 = x5 ? (s) => s : (s) => s instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const o of t.cssRules) e += o.cssText;
  return s7(e);
})(s) : s;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: i7, defineProperty: l7, getOwnPropertyDescriptor: a7, getOwnPropertyNames: C7, getOwnPropertySymbols: c7, getPrototypeOf: h7 } = Object, M1 = globalThis, G5 = M1.trustedTypes, d7 = G5 ? G5.emptyScript : "", F5 = M1.reactiveElementPolyfillSupport, W1 = (s, t) => s, a5 = { toAttribute(s, t) {
  switch (t) {
    case Boolean:
      s = s ? d7 : null;
      break;
  ...
  return e;
} }, L5 = (s, t) => !i7(s, t), W5 = { attribute: !0, type: String, converter: a5, reflect: !1, hasChanged: L5 };
...
let I1 = class extends HTMLElement {
  ...
  static createProperty(t, e = W5) {
    if (e.state && (e.attribute = !1), this._$Ei(), this.elementProperties.set(t, e), !e.noAccessor) {
      const o = Symbol(), n = this.getPropertyDescriptor(t, o, e);
      n !== void 0 && l7(this.prototype, t, n);
    }
  }
  static getPropertyDescriptor(t, e, o) {
    const { get: n, set: r } = a7(this.prototype, t) ?? { get() {
      return this[e];
    }, set(i) {
      this[e] = i;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(W1("properties"))) {
      const e = this.properties, o = [...C7(e), ...c7(e)];
      for (const n of o) this.createProperty(n, e[n]);
    }
    const t = this[Symbol.metadata];
    if (t !== null) {
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      const o = new Set(t.flat(1 / 0).reverse());
      for (const n of o) e.unshift(j5(n));
    } else t !== void 0 && e.push(j5(t));
    return e;
  }
  static _$Eu(t, e) {
    const o = e.attribute;
  ...
  createRenderRoot() {
    const t = this.shadowRoot ?? this.attachShadow(this.constructor.shadowRootOptions);
    return r7(t, this.constructor.elementStyles), t;
  }
  connectedCallback() {
    var t;
    this.renderRoot ?? (this.renderRoot = this.createRenderRoot()), this.enableUpdating(!0), (t = this._$EO) == null || t.forEach((e) => {
  ...
  _$EC(t, e) {
    ...
    const n = this.constructor.elementProperties.get(t), r = this.constructor._$Eu(t, n);
    if (r !== void 0 && n.reflect === !0) {
      const i = (((o = n.converter) == null ? void 0 : o.toAttribute) !== void 0 ? n.converter : a5).toAttribute(e, n.type);
      this._$Em = t, i == null ? this.removeAttribute(r) : this.setAttribute(r, i), this._$Em = null;
    }
  }
  _$AK(t, e) {
    ...
    const n = this.constructor, r = n._$Eh.get(t);
    if (r !== void 0 && this._$Em !== r) {
      const i = n.getPropertyOptions(r), C = typeof i.converter == "function" ? { fromAttribute: i.converter } : ((o = i.converter) == null ? void 0 : o.fromAttribute) !== void 0 ? i.converter : a5;
      this._$Em = r, this[r] = C.fromAttribute(e, i.type), this._$Em = null;
    }
  }
  requestUpdate(t, e, o) {
    if (t !== void 0) {
      if (o ?? (o = this.constructor.getPropertyOptions(t)), !(o.hasChanged ?? L5)(this[t], e)) return;
      this.P(t, e, o);
    }
    this.isUpdatePending === !1 && (this._$ES = this._$ET());
  }
...
I1.elementStyles = [], I1.shadowRootOptions = { mode: "open" }, I1[W1("elementProperties")] = /* @__PURE__ */ new Map(), I1[W1("finalized")] = /* @__PURE__ */ new Map(), F5 == null || F5({ ReactiveElement: I1 }), (M1.reactiveElementVersions ?? (M1.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const y7 = { attribute: !0, type: String, converter: a5, reflect: !1, hasChanged: L5 }, p7 = (s = y7, t, e) => {
  const { kind: o, metadata: n } = e;
  let r = globalThis.litPropertyMetadata.get(n);
  if (r === void 0 && globalThis.litPropertyMetadata.set(n, r = /* @__PURE__ */ new Map()), r.set(e.name, s), o === "accessor") {
    const { name: i } = e;
...
function k1(s) {
  return (t, e) => typeof e == "object" ? p7(s, t, e) : ((o, n, r) => {
    const i = n.hasOwnProperty(r);
    return n.constructor.createProperty(r, i ? { ...o, wrapped: !0 } : o), i ? Object.getOwnPropertyDescriptor(n, r) : void 0;
  })(s, t, e);
}
...
`;
var g7 = Object.defineProperty, f7 = Object.getOwnPropertyDescriptor, E1 = (s, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? f7(t, e) : t, r = s.length - 1, i; r >= 0; r--)
    (i = s[r]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && g7(t, e, n), n;
}, N1;
const f1 = (N1 = class extends p {
  constructor() {
    super(...arguments), this.name = "", this.label = "", this.rotate = "0", this.flip = "", this.color = "", this._size = "sm";
  }
  get size() {
  ...
  set size(s) {
    this._size = N1.VALID_TYPES.includes(
      s
    ) ? s : "sm";
  }
  getIcon() {
    const s = v7[this.name], t = !!this.label;
    if (!s) return null;
    const e = new DOMParser().parseFromString(s, "image/svg+xml").documentElement;
    return e instanceof SVGElement ? (e.setAttribute("role", "img"), e.setAttribute("aria-label", t ? this.label : ""), e.setAttribute("aria-hidden", t ? "false" : "true"), e.style.rotate = `${this.rotate}deg`, e.style.color = this.color || "currentcolor", e.classList.add(`nys-icon--${this.size}`), e.classList.add("nys-icon--svg"), this.flip && e.classList.add(`nys-icon--flip-${this.flip}`), e) : null;
  }
...
E1([
  k1({ type: String })
], f1.prototype, "label", 2);
E1([
  k1({ type: String })
], f1.prototype, "rotate", 2);
E1([
  k1({ type: String })
], f1.prototype, "flip", 2);
E1([
  k1({ type: String })
], f1.prototype, "color", 2);
E1([
  k1({ reflect: !0 })
], f1.prototype, "size", 1);
let b7 = f1;
customElements.get("nys-icon") || customElements.define("nys-icon", b7);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const C5 = globalThis, c5 = C5.trustedTypes, Y5 = c5 ? c5.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, v2 = "$lit$", t1 = `lit$${Math.random().toFixed(9).slice(2)}$`, u2 = "?" + t1, _7 = `<${u2}>`, p1 = document, h5 = () => p1.createComment(""), J1 = (s) => s === null || typeof s != "object" && typeof s != "function", M5 = Array.isArray, w7 = (s) => M5(s) || typeof (s == null ? void 0 : s[Symbol.iterator]) == "function", u5 = `[ 	
\f\r]`, T1 = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, K5 = /-->/g, J5 = />/g, h1 = RegExp(`>|${u5}(?:([^\\s"'>=/]+)(${u5}*=${u5}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), X5 = /'/g, Q5 = /"/g, g2 = /^(?:script|style|textarea|title)$/i, X1 = Symbol.for("lit-noChange"), f = Symbol.for("lit-nothing"), t2 = /* @__PURE__ */ new WeakMap(), y1 = p1.createTreeWalker(p1, 129);
function f2(s, t) {
  if (!M5(s) || !s.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return Y5 !== void 0 ? Y5.createHTML(t) : t;
}
const m7 = (s, t) => {
  const e = s.length - 1, o = [];
  let n, r = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", i = T1;
  for (let C = 0; C < e; C++) {
    const c = s[C];
    let y, v, h = -1, B = 0;
    for (; B < c.length && (i.lastIndex = B, v = i.exec(c), v !== null); ) B = i.lastIndex, i === T1 ? v[1] === "!--" ? i = K5 : v[1] !== void 0 ? i = J5 : v[2] !== void 0 ? (g2.test(v[2]) && (n = RegExp("</" + v[2], "g")), i = h1) : v[3] !== void 0 && (i = h1) : i === h1 ? v[0] === ">" ? (i = n ?? T1, h = -1) : v[1] === void 0 ? h = -2 : (h = i.lastIndex - v[2].length, y = v[1], i = v[3] === void 0 ? h1 : v[3] === '"' ? Q5 : X5) : i === Q5 || i === X5 ? i = h1 : i === K5 || i === J5 ? i = T1 : (i = h1, n = void 0);
    const N = i === h1 && s[C + 1].startsWith("/>") ? " " : "";
    r += i === T1 ? c + _7 : h >= 0 ? (o.push(y), c.slice(0, h) + v2 + c.slice(h) + t1 + N) : c + t1 + (h === -2 ? C : N);
  }
  return [f2(s, r + (s[e] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), o];
};
let g5 = class b2 {
  constructor({ strings: t, _$litType$: e }, o) {
    ...
    this.parts = [];
    let r = 0, i = 0;
    const C = t.length - 1, c = this.parts, [y, v] = m7(t, e);
    if (this.el = b2.createElement(y, o), y1.currentNode = this.el.content, e === 2 || e === 3) {
      const h = this.el.content.firstChild;
      h.replaceWith(...h.childNodes);
    }
    for (; (n = y1.nextNode()) !== null && c.length < C; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) for (const h of n.getAttributeNames()) if (h.endsWith(v2)) {
          const B = v[i++], N = n.getAttribute(h).split(t1), t5 = /([.?@])?(.*)/.exec(B);
          c.push({ type: 1, index: r, name: t5[2], strings: N, ctor: t5[1] === "." ? L7 : t5[1] === "?" ? M7 : t5[1] === "@" ? $7 : p5 }), n.removeAttribute(h);
        } else h.startsWith(t1) && (c.push({ type: 6, index: r }), n.removeAttribute(h));
        if (g2.test(n.tagName)) {
          const h = n.textContent.split(t1), B = h.length - 1;
          if (B > 0) {
            n.textContent = c5 ? c5.emptyScript : "";
            for (let N = 0; N < B; N++) n.append(h[N], h5()), y1.nextNode(), c.push({ type: 2, index: ++r });
            n.append(h[B], h5());
          }
        }
      } else if (n.nodeType === 8) if (n.data === u2) c.push({ type: 2, index: r });
      else {
        let h = -1;
        for (; (h = n.data.indexOf(t1, h + 1)) !== -1; ) c.push({ type: 7, index: r }), h += t1.length - 1;
      }
      r++;
    }
  }
  static createElement(t, e) {
    const o = p1.createElement("template");
    return o.innerHTML = t, o;
  }
};
function $1(s, t, e = s, o) {
  var n, r;
  if (t === X1) return t;
  let i = o !== void 0 ? (n = e._$Co) == null ? void 0 : n[o] : e._$Cl;
  const C = J1(t) ? void 0 : t._$litDirective$;
  return (i == null ? void 0 : i.constructor) !== C && ((r = i == null ? void 0 : i._$AO) == null || r.call(i, !1), C === void 0 ? i = void 0 : (i = new C(s), i._$AT(s, e, o)), o !== void 0 ? (e._$Co ?? (e._$Co = []))[o] = i : e._$Cl = i), i !== void 0 && (t = $1(s, i._$AS(s, t.values), i, o)), t;
}
class x7 {
  constructor(t, e) {
  ...
  u(t) {
    const { el: { content: e }, parts: o } = this._$AD, n = ((t == null ? void 0 : t.creationScope) ?? p1).importNode(e, !0);
    y1.currentNode = n;
    let r = y1.nextNode(), i = 0, C = 0, c = o[0];
    for (; c !== void 0; ) {
      if (i === c.index) {
        let y;
        c.type === 2 ? y = new _2(r, r.nextSibling, this, t) : c.type === 1 ? y = new c.ctor(r, c.name, c.strings, this, t) : c.type === 6 && (y = new Z7(r, this, t)), this._$AV.push(y), c = o[++C];
      }
      i !== (c == null ? void 0 : c.index) && (r = y1.nextNode(), i++);
    }
    return y1.currentNode = p1, n;
  }
  p(t) {
    let e = 0;
...
let _2 = class w2 {
  ...
  _$AI(t, e = this) {
    t = $1(this, t, e), J1(t) ? t === f || t == null || t === "" ? (this._$AH !== f && this._$AR(), this._$AH = f) : t !== this._$AH && t !== X1 && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : w7(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== f && J1(this._$AH) ? this._$AA.nextSibling.data = t : this.T(p1.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var e;
    const { values: o, _$litType$: n } = t, r = typeof n == "number" ? this._$AC(t) : (n.el === void 0 && (n.el = g5.createElement(f2(n.h, n.h[0]), this.options)), n);
    if (((e = this._$AH) == null ? void 0 : e._$AD) === r) this._$AH.p(o);
    else {
      const i = new x7(r, this), C = i.u(this.options);
      i.p(o), this.T(C), this._$AH = i;
    }
  }
  _$AC(t) {
    let e = t2.get(t.strings);
    return e === void 0 && t2.set(t.strings, e = new g5(t)), e;
  }
  k(t) {
    M5(this._$AH) || (this._$AH = [], this._$AR());
    const e = this._$AH;
    let o, n = 0;
    for (const r of t) n === e.length ? e.push(o = new w2(this.O(h5()), this.O(h5()), this, this.options)) : o = e[n], o._$AI(r), n++;
  ...
  constructor(t, e, o, n, r) {
    this.type = 1, this._$AH = f, this._$AN = void 0, this.element = t, this.name = e, this._$AM = n, this.options = r, o.length > 2 || o[0] !== "" || o[1] !== "" ? (this._$AH = Array(o.length - 1).fill(new String()), this.strings = o) : this._$AH = f;
  }
  _$AI(t, e = this, o, n) {
    const r = this.strings;
    let i = !1;
    if (r === void 0) t = $1(this, t, e, 0), i = !J1(t) || t !== this._$AH && t !== X1, i && (this._$AH = t);
    else {
      const C = t;
      let c, y;
      for (t = r[0], c = 0; c < r.length - 1; c++) y = $1(this, C[o + c], e, c), y === X1 && (y = this._$AH[c]), i || (i = !J1(y) || y !== this._$AH[c]), y === f ? t = f : t !== f && (t += (y ?? "") + r[c + 1]), this._$AH[c] = y;
    }
    i && !n && this.j(t);
  }
  j(t) {
...
class $7 extends p5 {
  ...
  _$AI(t, e = this) {
    if ((t = $1(this, t, e, 0) ?? f) === X1) return;
    const o = this._$AH, n = t === f && o !== f || t.capture !== o.capture || t.once !== o.once || t.passive !== o.passive, r = t !== f && (o === f || n);
...
const e2 = C5.litHtmlPolyfillSupport;
e2 == null || e2(g5, _2), (C5.litHtmlVersions ?? (C5.litHtmlVersions = [])).push("3.2.1");
/**
 * @license
 ...
 */
const Q = (s) => s ?? f;
var H7 = Object.defineProperty, V7 = Object.getOwnPropertyDescriptor, V = (s, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? V7(t, e) : t, r = s.length - 1, i; r >= 0; r--)
    (i = s[r]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && H7(t, e, n), n;
};
let S7 = 0;
var W;
const M = (W = class extends p {
  constructor() {
  ...
  "ghost",
  "text"
], W.VALID_TYPES = ["submit", "reset", "button"], W.styles = o7, W);
V([
  H({ type: String })
], M.prototype, "id", 2);
V([
...
let k7 = M;
customElements.get("nys-button") || customElements.define("nys-button", k7);
var E7 = Object.defineProperty, z7 = Object.getOwnPropertyDescriptor, E = (s, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? z7(t, e) : t, r = s.length - 1, i; r >= 0; r--)
    (i = s[r]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && E7(t, e, n), n;
};
let A7 = 0;
var e1;
const k = (e1 = class extends p {
  constructor() {
  ...
  set type(t) {
    this._type = e1.VALID_TYPES.includes(
      t
    ) ? t : "base";
  }
  ...
  _checkSlotContent() {
    ...
    if (t) {
      const o = t.assignedNodes({ flatten: !0 }).filter(
        (n) => {
          var r;
          return n.nodeType === Node.ELEMENT_NODE || n.nodeType === Node.TEXT_NODE && ((r = n.textContent) == null ? void 0 : r.trim());
        }
      );
      ...
      e.trim() !== "" ? e : void 0
          ...
          >
            ...
            <div class="nys-alert__texts">
              ...
              ${this._slotHasContent ? a`<slot></slot>` : ((n = this.text) == null ? void 0 : n.trim().length) > 0 ? a`<p class="nys-alert__text">${this.text}</p>` : ""}
            ...
            ${this.dismissible && this.type !== "emergency" ? a`<div class="close-container">
                  <nys-button
                    id="dismiss-btn"
                    variant="ghost"
                    prefixIcon="close"
                  ...
                  ></nys-button>
                </div>` : this.dismissible && this.type === "emergency" ? a`<div class="close-container">
                    <nys-button
                      id="dismiss-btn"
                      variant="ghost"
                      prefixIcon="close"
...
`;
var O7 = Object.defineProperty, U7 = Object.getOwnPropertyDescriptor, C1 = (s, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? U7(t, e) : t, r = s.length - 1, i; r >= 0; r--)
    (i = s[r]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && O7(t, e, n), n;
};
let D7 = 0;
var o1;
const K = (o1 = class extends p {
  constructor() {
  ...
  set shape(t) {
    this._shape = o1.VALID_SHAPES.includes(
      t
  ...
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-avatar-${Date.now()}-${D7++}`);
  }
  render() {
    var t, e, o, n;
    return a`
      <label class="nys-avatar" id=${this.id}>
        <div class="nys-avatar__content">
          <div
            ...
            role=${L(this.image ? void 0 : "img")}
            aria-label=${L(this.image ? void 0 : this.label)}
          >
            ${((e = this.image) == null ? void 0 : e.length) > 0 ? a`<img
                ...
                />` : ((o = this.initials) == null ? void 0 : o.length) > 0 ? a`<span
                    ...
                    aria-hidden="true"
                    >${this.initials}</span
                  >` : ((n = this.icon) == null ? void 0 : n.length) > 0 ? a`<div part="nys-avatar__icon">
                      <nys-icon
...
let I7 = K;
customElements.get("nys-avatar") || customElements.define("nys-avatar", I7);
const N7 = b`
  :host {
    /* Anything that can be overridden should be defined here */
...
`;
var T7 = Object.defineProperty, R7 = Object.getOwnPropertyDescriptor, S = (s, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? R7(t, e) : t, r = s.length - 1, i; r >= 0; r--)
    (i = s[r]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && T7(t, e, n), n;
};
let q7 = 0;
var z;
const $ = (z = class extends p {
  ...
  "ghost",
  "text"
], z.VALID_TYPES = ["submit", "reset", "button"], z.styles = N7, z);
S([
  l({ type: String })
], $.prototype, "id", 2);
S([
...
S([
  l({ type: String })
], $.prototype, "prefixIcon", 2);
S([
  l({ type: String })
], $.prototype, "suffixIcon", 2);
S([
  l({ type: Boolean, reflect: !0 })
...
let j7 = $;
customElements.get("nys-button") || customElements.define("nys-button", j7);
const m2 = b`
  :host {
    /* Anything that can be overridden should be defined here */
...
`;
var G7 = Object.defineProperty, F7 = Object.getOwnPropertyDescriptor, c1 = (s, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? F7(t, e) : t, r = s.length - 1, i; r >= 0; r--)
    (i = s[r]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && G7(t, e, n), n;
};
let W7 = 0;
var n1;
const J = (n1 = class extends p {
  constructor() {
    super(...arguments), this.id = "", this.name = "", this.required = !1, this.showError = !1, this.errorMessage = "", this.label = "", this.description = "", this._size = "md";
  }
  get size() {
    return this._size;
  }
  ...
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-checkbox-${Date.now()}-${W7++}`);
  }
  updated(t) {
    t.has("size") && this.updateCheckboxSize();
  }
  ...
  render() {
    return a` <div class="nys-checkboxgroup">
      ...
      ${this.showError && this.errorMessage ? a`<div class="nys-checkbox__error">
            <nys-icon name="error" size="xl"></nys-icon>
            ${this.errorMessage}
          </div>` : ""}
    </div>`;
  }
}, n1.VALID_SIZES = ["sm", "md"], n1.styles = m2, n1);
c1([
  l({ type: String })
], J.prototype, "id", 2);
c1([
...
let Y7 = J;
customElements.get("nys-checkboxgroup") || customElements.define("nys-checkboxgroup", Y7);
var K7 = Object.defineProperty, J7 = Object.getOwnPropertyDescriptor, O = (s, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? J7(t, e) : t, r = s.length - 1, i; r >= 0; r--)
    (i = s[r]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && K7(t, e, n), n;
};
let X7 = 0;
var s1;
const A = (s1 = class extends p {
  constructor() {
    super(...arguments), this.checked = !1, this.disabled = !1, this.required = !1, this.label = "", this.description = "", this.id = "", this.name = "", this.value = "", this.showError = !1, this.errorMessage = "", this._size = "md";
  }
  get size() {
    return this._size;
  }
  ...
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-checkbox-${Date.now()}-${X7++}`);
  }
  ...
  _handleKeydown(t) {
    t.code === "Space" && (t.preventDefault(), this.disabled || (this.checked = !this.checked, this.dispatchEvent(
      new CustomEvent("change", {
        detail: { checked: this.checked },
        bubbles: !0,
        composed: !0
...
}, s1.VALID_SIZES = ["sm", "md"], s1.styles = m2, s1);
O([
  l({ type: Boolean })
...
let Q7 = A;
customElements.get("nys-checkbox") || customElements.define("nys-checkbox", Q7);
const t3 = {
  // --------- UX Team Main Library (below) --------- //
  // *** CORE *** //
  account_circle: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
...
`;
var o3 = Object.defineProperty, n3 = Object.getOwnPropertyDescriptor, z1 = (s, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? n3(t, e) : t, r = s.length - 1, i; r >= 0; r--)
    (i = s[r]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && o3(t, e, n), n;
}, r1;
const b1 = (r1 = class extends p {
  constructor() {
    super(...arguments), this.name = "", this.label = "", this.rotate = "0", this.flip = "", this.color = "", this._size = "sm";
  }
  get size() {
...
let s3 = b1;
customElements.get("nys-icon") || customElements.define("nys-icon", s3);
const x2 = b`
  :host {
...
`;
var r3 = Object.defineProperty, i3 = Object.getOwnPropertyDescriptor, j = (s, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? i3(t, e) : t, r = s.length - 1, i; r >= 0; r--)
    (i = s[r]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && r3(t, e, n), n;
};
let l3 = 0;
var i1;
const U = (i1 = class extends p {
  constructor() {
  ...
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-radiogroup-${Date.now()}-${l3++}`), this.addEventListener("change", this._handleRadioButtonChange);
  }
  disconnectedCallback() {
  ...
  _handleRadioButtonChange(t) {
    ...
    this.selectedName = o, this.selectedValue = n, console.log("you have selected:", this.selectedName, this.selectedValue);
  }
  render() {
    return a` <div role="radiogroup" class="nys-radiogroup">
      ${this.label && a` <div class="nys-radiobutton__text">
        <div class="nys-radiobutton__requiredwrapper">
          <label for=${this.id} class="nys-radiogroup__label"
            >${this.label}</label
          >
          ${this.required ? a`<label class="nys-radiobutton__required">*</label>` : ""}
        </div>
      ...
      ${this.showError && this.errorMessage ? a`<div class="nys-radiobutton__error">
            <nys-icon name="error" size="xl"></nys-icon>
            ${this.errorMessage}
          </div>` : ""}
    </div>`;
  }
}, i1.VALID_SIZES = ["sm", "md"], i1.styles = x2, i1);
j([
  l({ type: String })
], U.prototype, "id", 2);
j([
...
let a3 = U;
customElements.get("nys-radiogroup") || customElements.define("nys-radiogroup", a3);
var C3 = Object.defineProperty, c3 = Object.getOwnPropertyDescriptor, X = (s, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? c3(t, e) : t, r = s.length - 1, i; r >= 0; r--)
    (i = s[r]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && C3(t, e, n), n;
};
let h3 = 0;
var d;
const G = (d = class extends p {
  constructor() {
  ...
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-radiobutton-${Date.now()}-${h3++}`), this.checked && (d.buttonGroup[this.name] && (d.buttonGroup[this.name].checked = !1, d.buttonGroup[this.name].requestUpdate()), d.buttonGroup[this.name] = this);
  }
  updated(t) {
...
}, d.VALID_SIZES = ["sm", "md"], d.buttonGroup = {}, d.styles = x2, d);
X([
  l({ type: Boolean })
...
let d3 = G;
customElements.get("nys-radiobutton") || customElements.define("nys-radiobutton", d3);
const y3 = b`
  :host {
...
`;
var p3 = Object.defineProperty, Q1 = (s, t, e, o) => {
  for (var n = void 0, r = s.length - 1, i; r >= 0; r--)
    (i = s[r]) && (n = i(t, e, n) || n);
  return n && p3(t, e, n), n;
};
class _1 extends p {
  ...
  firstUpdated() {
    ...
    t && t.addEventListener("slotchange", () => {
      ...
      o.length > 0 && (this.label = ((n = o[0].textContent) == null ? void 0 : n.trim()) || "");
    });
  }
  render() {
    return a`
...
var v3 = Object.defineProperty, u3 = Object.getOwnPropertyDescriptor, D = (s, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? u3(t, e) : t, r = s.length - 1, i; r >= 0; r--)
    (i = s[r]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && v3(t, e, n), n;
}, l1;
const P = (l1 = class extends p {
  constructor() {
  ...
  _handleSlotChange() {
    ...
    if (t) {
      const n = t.assignedElements({ flatten: !0 }), r = (o = this.shadowRoot) == null ? void 0 : o.querySelector("select");
      r && n.forEach((i) => {
        var C;
        if (i instanceof _1) {
          const c = document.createElement("option");
          c.value = i.value, c.textContent = i.label || ((C = i.textContent) == null ? void 0 : C.trim()) || "", c.disabled = i.disabled, c.selected = i.selected, r.appendChild(c);
        }
      });
    }
  }
  ...
  render() {
    return a`
      <div class="nys-select">
        ${this.label && a` <div class="nys-select__text">
          <div class="nys-select__requiredwrapper">
            <label for=${this.id} class="nys-select__label"
              >${this.label}</label
            >
            ${this.required ? a`<label class="nys-select__required">*</label>` : ""}
          </div>
        ...
        ${this.showError && this.errorMessage ? a`<div class="nys-select__error">
              <nys-icon name="error" size="xl"></nys-icon>
              ${this.errorMessage}
            </div>` : ""}
      </div>
...
}, l1.VALID_WIDTHS = ["sm", "md", "lg", "full"], l1.styles = y3, l1);
D([
  l({ type: String })
], P.prototype, "id", 2);
D([
...
let g3 = P;
customElements.get("nys-select") || customElements.define("nys-select", g3);
const f3 = b`
  :host {
    /* Anything that can be overridden should be defined here */
...
`;
var b3 = Object.defineProperty, _3 = Object.getOwnPropertyDescriptor, Z = (s, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? _3(t, e) : t, r = s.length - 1, i; r >= 0; r--)
    (i = s[r]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && b3(t, e, n), n;
}, T;
const x = (T = class extends p {
  constructor() {
    super(...arguments), this.id = "", this.name = "", this.label = "", this.description = "", this.placeholder = "", this.value = "", this.disabled = !1, this.readonly = !1, this.required = !1, this.form = "", this.maxlength = null, this.width = "full", this.rows = 4, this._resize = "vertical", this.showError = !1, this.errorMessage = "";
  }
  get resize() {
    return this._resize;
  }
  ...
  updated(t) {
    t.has("width") && (this.width = T.VALID_WIDTHS.includes(this.width) ? this.width : "full"), t.has("rows") && (this.rows = this.rows ?? 4);
  }
  ...
  _handleInput(t) {
    ...
    const o = e.checkValidity();
    this.dispatchEvent(
      new CustomEvent("nys-checkValidity", {
        detail: { checkValidity: o },
        bubbles: !0,
        composed: !0
      })
    );
  ...
  render() {
    return a`
      <label class="nys-textarea">
        ${this.label && a` <div class="nys-textarea__text">
          <div class="nys-textarea__requiredwrapper">
            <label for=${this.id} class="nys-textarea__label"
              >${this.label}</label
            >
            ${this.required ? a`<label class="nys-textarea__required">*</label>` : ""}
          </div>
        ...
        ></textarea>
        ${this.showError && this.errorMessage ? a`<div class="nys-textarea__error">
              <nys-icon name="error" size="xl"></nys-icon>
              ${this.errorMessage}
            </div>` : ""}
      </label>
...
}, T.VALID_WIDTHS = ["sm", "md", "lg", "full"], T.VALID_RESIZE = ["vertical", "none"], T.styles = f3, T);
Z([
  l({ type: String })
], x.prototype, "id", 2);
Z([
...
let w3 = x;
customElements.get("nys-textarea") || customElements.define("nys-textarea", w3);
const m3 = b`
  :host {
    /* Anything that can be overridden should be defined here */
...
`;
var x3 = Object.defineProperty, L3 = Object.getOwnPropertyDescriptor, _ = (s, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? L3(t, e) : t, r = s.length - 1, i; r >= 0; r--)
    (i = s[r]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && x3(t, e, n), n;
}, R;
const u = (R = class extends p {
  constructor() {
  ...
  updated(t) {
    t.has("width") && (this.width = R.VALID_WIDTHS.includes(this.width) ? this.width : "full");
  }
  // Handle input event to check pattern validity
  _handleInput(t) {
    const e = t.target;
  ...
  render() {
    return a`
      <div class="nys-textinput">
        ${this.label && a` <div class="nys-textinput__text">
          <div class="nys-textinput__requiredwrapper">
            <label for=${this.id} class="nys-textinput__label"
              >${this.label}</label
            >
            ${this.required ? a`<label class="nys-textinput__required">*</label>` : ""}
          </div>
        ...
        <input
          ...
          @change="${this._handleChange}"
        />
        ${this.showError && this.errorMessage ? a`<div class="nys-textinput__error">
              <nys-icon name="error" size="xl"></nys-icon>
              ${this.errorMessage}
            </div>` : ""}
      </div>
  ...
  "text",
  "url"
], R.VALID_WIDTHS = ["sm", "md", "lg", "full"], R.styles = m3, R);
_([
  l({ type: String })
], u.prototype, "id", 2);
_([
...
let M3 = u;
customElements.get("nys-textinput") || customElements.define("nys-textinput", M3);
const $3 = b`
  :host {
...
`;
var Z3 = Object.defineProperty, H3 = Object.getOwnPropertyDescriptor, F = (s, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? H3(t, e) : t, r = s.length - 1, i; r >= 0; r--)
    (i = s[r]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && Z3(t, e, n), n;
};
let V3 = 0;
var a1;
const I = (a1 = class extends p {
  constructor() {
  ...
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-toggle-${Date.now()}-${V3++}`);
  }
  // Handle focus event
  _handleFocus() {
    this.dispatchEvent(new Event("focus"));
...
}, a1.styles = $3, a1.VALID_SIZES = ["sm", "md"], a1);
F([
  l({ type: String })
], I.prototype, "id", 2);
F([
...
let S3 = I;
customElements.get("nys-toggle") || customElements.define("nys-toggle", S3);
const k3 = b`
  :host {
...
`, E3 = `<svg xmlns="http://www.w3.org/2000/svg" width="91" height="55" viewBox="0 0 91 55" fill="none">
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const s5 = globalThis, $5 = s5.ShadowRoot && (s5.ShadyCSS === void 0 || s5.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, L2 = Symbol(), o2 = /* @__PURE__ */ new WeakMap();
let z3 = class {
  constructor(s, t, e) {
    if (this._$cssResult$ = !0, e !== L2) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
    this.cssText = s, this.t = t;
  }
  get styleSheet() {
    let s = this.o;
    ...
    if ($5 && s === void 0) {
      const e = t !== void 0 && t.length === 1;
      e && (s = o2.get(t)), s === void 0 && ((this.o = s = new CSSStyleSheet()).replaceSync(this.cssText), e && o2.set(t, s));
    }
    return s;
  }
  toString() {
...
const A3 = (s) => new z3(typeof s == "string" ? s : s + "", void 0, L2), P3 = (s, t) => {
  if ($5) s.adoptedStyleSheets = t.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet);
  else for (const e of t) {
    const o = document.createElement("style"), n = s5.litNonce;
    n !== void 0 && o.setAttribute("nonce", n), o.textContent = e.cssText, s.appendChild(o);
  }
}, n2 = $5 ? (s) => s : (s) => s instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const o of t.cssRules) e += o.cssText;
  return A3(e);
})(s) : s;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: B3, defineProperty: O3, getOwnPropertyDescriptor: U3, getOwnPropertyNames: D3, getOwnPropertySymbols: I3, getPrototypeOf: N3 } = Object, Z1 = globalThis, s2 = Z1.trustedTypes, T3 = s2 ? s2.emptyScript : "", r2 = Z1.reactiveElementPolyfillSupport, Y1 = (s, t) => s, d5 = { toAttribute(s, t) {
  switch (t) {
    case Boolean:
      s = s ? T3 : null;
      break;
  ...
  return e;
} }, Z5 = (s, t) => !B3(s, t), i2 = { attribute: !0, type: String, converter: d5, reflect: !1, hasChanged: Z5 };
Symbol.metadata ?? (Symbol.metadata = Symbol("metadata")), Z1.litPropertyMetadata ?? (Z1.litPropertyMetadata = /* @__PURE__ */ new WeakMap());
class R1 extends HTMLElement {
  ...
  static createProperty(t, e = i2) {
    if (e.state && (e.attribute = !1), this._$Ei(), this.elementProperties.set(t, e), !e.noAccessor) {
      const o = Symbol(), n = this.getPropertyDescriptor(t, o, e);
      n !== void 0 && O3(this.prototype, t, n);
    }
  }
  static getPropertyDescriptor(t, e, o) {
    const { get: n, set: r } = U3(this.prototype, t) ?? { get() {
      return this[e];
    }, set(i) {
      this[e] = i;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(Y1("properties"))) {
      const e = this.properties, o = [...D3(e), ...I3(e)];
      for (const n of o) this.createProperty(n, e[n]);
    }
    const t = this[Symbol.metadata];
    if (t !== null) {
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      const o = new Set(t.flat(1 / 0).reverse());
      for (const n of o) e.unshift(n2(n));
    } else t !== void 0 && e.push(n2(t));
    return e;
  }
  static _$Eu(t, e) {
    const o = e.attribute;
  ...
  _$EC(t, e) {
    ...
    const n = this.constructor.elementProperties.get(t), r = this.constructor._$Eu(t, n);
    if (r !== void 0 && n.reflect === !0) {
      const i = (((o = n.converter) == null ? void 0 : o.toAttribute) !== void 0 ? n.converter : d5).toAttribute(e, n.type);
      this._$Em = t, i == null ? this.removeAttribute(r) : this.setAttribute(r, i), this._$Em = null;
    }
  }
  _$AK(t, e) {
    ...
    const n = this.constructor, r = n._$Eh.get(t);
    if (r !== void 0 && this._$Em !== r) {
      const i = n.getPropertyOptions(r), C = typeof i.converter == "function" ? { fromAttribute: i.converter } : ((o = i.converter) == null ? void 0 : o.fromAttribute) !== void 0 ? i.converter : d5;
      this._$Em = r, this[r] = C.fromAttribute(e, i.type), this._$Em = null;
    }
  }
  requestUpdate(t, e, o) {
    if (t !== void 0) {
      if (o ?? (o = this.constructor.getPropertyOptions(t)), !(o.hasChanged ?? Z5)(this[t], e)) return;
      this.P(t, e, o);
    }
    this.isUpdatePending === !1 && (this._$ES = this._$ET());
  }
...
R1.elementStyles = [], R1.shadowRootOptions = { mode: "open" }, R1[Y1("elementProperties")] = /* @__PURE__ */ new Map(), R1[Y1("finalized")] = /* @__PURE__ */ new Map(), r2 == null || r2({ ReactiveElement: R1 }), (Z1.reactiveElementVersions ?? (Z1.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const R3 = { attribute: !0, type: String, converter: d5, reflect: !1, hasChanged: Z5 }, q3 = (s = R3, t, e) => {
  const { kind: o, metadata: n } = e;
  let r = globalThis.litPropertyMetadata.get(n);
  if (r === void 0 && globalThis.litPropertyMetadata.set(n, r = /* @__PURE__ */ new Map()), r.set(e.name, s), o === "accessor") {
    const { name: i } = e;
...
function w(s) {
  return (t, e) => typeof e == "object" ? q3(s, t, e) : ((o, n, r) => {
    const i = n.hasOwnProperty(r);
    return n.constructor.createProperty(r, i ? { ...o, wrapped: !0 } : o), i ? Object.getOwnPropertyDescriptor(n, r) : void 0;
  })(s, t, e);
}
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const r5 = globalThis, H5 = r5.ShadowRoot && (r5.ShadyCSS === void 0 || r5.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, M2 = Symbol(), l2 = /* @__PURE__ */ new WeakMap();
let G3 = class {
  constructor(s, t, e) {
    if (this._$cssResult$ = !0, e !== M2) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
    this.cssText = s, this.t = t;
  }
  get styleSheet() {
    let s = this.o;
    ...
    if (H5 && s === void 0) {
      const e = t !== void 0 && t.length === 1;
      e && (s = l2.get(t)), s === void 0 && ((this.o = s = new CSSStyleSheet()).replaceSync(this.cssText), e && l2.set(t, s));
    }
    return s;
  }
  toString() {
...
const F3 = (s) => new G3(typeof s == "string" ? s : s + "", void 0, M2), W3 = (s, t) => {
  if (H5) s.adoptedStyleSheets = t.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet);
  else for (const e of t) {
    const o = document.createElement("style"), n = r5.litNonce;
    n !== void 0 && o.setAttribute("nonce", n), o.textContent = e.cssText, s.appendChild(o);
  }
}, a2 = H5 ? (s) => s : (s) => s instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const o of t.cssRules) e += o.cssText;
  return F3(e);
})(s) : s;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Y3, defineProperty: K3, getOwnPropertyDescriptor: J3, getOwnPropertyNames: X3, getOwnPropertySymbols: Q3, getPrototypeOf: t0 } = Object, H1 = globalThis, C2 = H1.trustedTypes, e0 = C2 ? C2.emptyScript : "", c2 = H1.reactiveElementPolyfillSupport, K1 = (s, t) => s, y5 = { toAttribute(s, t) {
  switch (t) {
    case Boolean:
      s = s ? e0 : null;
      break;
  ...
  return e;
} }, V5 = (s, t) => !Y3(s, t), h2 = { attribute: !0, type: String, converter: y5, reflect: !1, hasChanged: V5 };
Symbol.metadata ?? (Symbol.metadata = Symbol("metadata")), H1.litPropertyMetadata ?? (H1.litPropertyMetadata = /* @__PURE__ */ new WeakMap());
class q1 extends HTMLElement {
  ...
  static createProperty(t, e = h2) {
    if (e.state && (e.attribute = !1), this._$Ei(), this.elementProperties.set(t, e), !e.noAccessor) {
      const o = Symbol(), n = this.getPropertyDescriptor(t, o, e);
      n !== void 0 && K3(this.prototype, t, n);
    }
  }
  static getPropertyDescriptor(t, e, o) {
    const { get: n, set: r } = J3(this.prototype, t) ?? { get() {
      return this[e];
    }, set(i) {
      this[e] = i;
    } };
  ...
  static getPropertyOptions(t) {
    return this.elementProperties.get(t) ?? h2;
  }
  static _$Ei() {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(K1("properties"))) {
      const e = this.properties, o = [...X3(e), ...Q3(e)];
      for (const n of o) this.createProperty(n, e[n]);
    }
    const t = this[Symbol.metadata];
    if (t !== null) {
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      const o = new Set(t.flat(1 / 0).reverse());
      for (const n of o) e.unshift(a2(n));
    } else t !== void 0 && e.push(a2(t));
    return e;
  }
  static _$Eu(t, e) {
    const o = e.attribute;
  ...
  _$EC(t, e) {
    ...
    const n = this.constructor.elementProperties.get(t), r = this.constructor._$Eu(t, n);
    if (r !== void 0 && n.reflect === !0) {
      const i = (((o = n.converter) == null ? void 0 : o.toAttribute) !== void 0 ? n.converter : y5).toAttribute(e, n.type);
      this._$Em = t, i == null ? this.removeAttribute(r) : this.setAttribute(r, i), this._$Em = null;
    }
  }
  _$AK(t, e) {
    ...
    const n = this.constructor, r = n._$Eh.get(t);
    if (r !== void 0 && this._$Em !== r) {
      const i = n.getPropertyOptions(r), C = typeof i.converter == "function" ? { fromAttribute: i.converter } : ((o = i.converter) == null ? void 0 : o.fromAttribute) !== void 0 ? i.converter : y5;
      this._$Em = r, this[r] = C.fromAttribute(e, i.type), this._$Em = null;
    }
  }
  requestUpdate(t, e, o) {
    if (t !== void 0) {
      if (o ?? (o = this.constructor.getPropertyOptions(t)), !(o.hasChanged ?? V5)(this[t], e)) return;
      this.P(t, e, o);
    }
    this.isUpdatePending === !1 && (this._$ES = this._$ET());
  }
...
q1.elementStyles = [], q1.shadowRootOptions = { mode: "open" }, q1[K1("elementProperties")] = /* @__PURE__ */ new Map(), q1[K1("finalized")] = /* @__PURE__ */ new Map(), c2 == null || c2({ ReactiveElement: q1 }), (H1.reactiveElementVersions ?? (H1.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const o0 = { attribute: !0, type: String, converter: y5, reflect: !1, hasChanged: V5 }, n0 = (s = o0, t, e) => {
  const { kind: o, metadata: n } = e;
  let r = globalThis.litPropertyMetadata.get(n);
  if (r === void 0 && globalThis.litPropertyMetadata.set(n, r = /* @__PURE__ */ new Map()), r.set(e.name, s), o === "accessor") {
    const { name: i } = e;
...
function A1(s) {
  return (t, e) => typeof e == "object" ? n0(s, t, e) : ((o, n, r) => {
    const i = n.hasOwnProperty(r);
    return n.constructor.createProperty(r, i ? { ...o, wrapped: !0 } : o), i ? Object.getOwnPropertyDescriptor(n, r) : void 0;
  })(s, t, e);
}
...
`;
var i0 = Object.defineProperty, l0 = Object.getOwnPropertyDescriptor, P1 = (s, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? l0(t, e) : t, r = s.length - 1, i; r >= 0; r--)
    (i = s[r]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && i0(t, e, n), n;
}, j1;
const w1 = (j1 = class extends p {
  constructor() {
    super(...arguments), this.name = "", this.label = "", this.rotate = "0", this.flip = "", this.color = "", this._size = "sm";
  }
  get size() {
  ...
  set size(s) {
    this._size = j1.VALID_TYPES.includes(
      s
    ) ? s : "sm";
  }
  getIcon() {
    const s = s0[this.name], t = !!this.label;
    if (!s) return null;
    const e = new DOMParser().parseFromString(s, "image/svg+xml").documentElement;
    return e instanceof SVGElement ? (e.setAttribute("role", "img"), e.setAttribute("aria-label", t ? this.label : ""), e.setAttribute("aria-hidden", t ? "false" : "true"), e.style.rotate = `${this.rotate}deg`, e.style.color = this.color || "currentcolor", e.classList.add(`nys-icon--${this.size}`), e.classList.add("nys-icon--svg"), this.flip && e.classList.add(`nys-icon--flip-${this.flip}`), e) : null;
  }
...
P1([
  A1({ type: String })
], w1.prototype, "label", 2);
P1([
  A1({ type: String })
], w1.prototype, "rotate", 2);
P1([
  A1({ type: String })
], w1.prototype, "flip", 2);
P1([
  A1({ type: String })
], w1.prototype, "color", 2);
P1([
  A1({ reflect: !0 })
], w1.prototype, "size", 1);
let a0 = w1;
customElements.get("nys-icon") || customElements.define("nys-icon", a0);
var C0 = Object.defineProperty, c0 = Object.getOwnPropertyDescriptor, m = (s, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? c0(t, e) : t, r = s.length - 1, i; r >= 0; r--)
    (i = s[r]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && C0(t, e, n), n;
}, d1;
const g = (d1 = class extends p {
  constructor() {
    super(), this.id = "", this.name = "", this._type = "text", this.label = "", this.description = "", this.placeholder = "", this.value = "", this.disabled = !1, this.readonly = !1, this.required = !1, this.form = "", this.pattern = "", this.maxlength = null, this.width = "full", this.step = null, this.min = null, this.max = null, this.showError = !1, this.errorMessage = "";
  }
  get type() {
  ...
  set type(s) {
    this._type = d1.VALID_TYPES.includes(
      s
    ) ? s : "text";
  }
  // Ensure the "width" property is valid after updates
  updated(s) {
    s.has("width") && (this.width = d1.VALID_WIDTHS.includes(this.width) ? this.width : "full");
  }
  // Handle input event to check pattern validity
  _handleInput(s) {
    const t = s.target;
  ...
  "text",
  "url"
], d1.VALID_WIDTHS = ["sm", "md", "lg", "full"], d1.styles = j3, d1);
m([
  w({ type: String })
], g.prototype, "id", 2);
m([
...
let h0 = g;
customElements.get("nys-textinput") || customElements.define("nys-textinput", h0);
var d0 = Object.defineProperty, y0 = Object.getOwnPropertyDescriptor, m1 = (s, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? y0(t, e) : t, r = s.length - 1, i; r >= 0; r--)
    (i = s[r]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && d0(t, e, n), n;
};
const S5 = class S5 extends p {
  constructor() {
  ...
  _getNysLogo() {
    return new DOMParser().parseFromString(E3, "image/svg+xml").documentElement;
  }
  _toggleTrustbar() {
  ...
  render() {
    return a`
      ${this.screenSize === "xs" || this.screenSize === "sm" ? a` <div class="nys-unavheader__toptrustbar">
              ...
              ${this.trustbarVisible ? a`<nys-button
      ...
      <header class="nys-unavheader" id="nys-universal-navigation">
        <div class="nys-unavheader__left">
          ...
          >
          ${this.screenSize === "md" || this.screenSize === "lg" || this.screenSize === "xl" ? a` <div class="nys-unavheader__officialmessage">
                <label id="nys-unavheader__official"
                  >An official website of New York State</label
                >
                <nys-button
        ...
        <div class="nys-unavheader__right">
          ${!this.isSearchFocused && !this.hideTranslate ? a`<div class="nys-unavheader__translatewrapper">
                ${this.screenSize === "xs" || this.screenSize === "sm" || this.screenSize === "md" ? a`<nys-button
                      variant="ghost"
                      prefixIcon="language"
                      id="nys-unavheader__translate"
                      class="nys-unavheader__iconbutton"
                      @click="${this._toggleLanguageList}"
                    ></nys-button>` : a`<nys-button
                      variant="ghost"
                      label="Translate"
      ...
      ([t, e]) => a`<a
          ...
          ${this.hideSearch ? null : this.screenSize === "xs" || this.screenSize === "sm" || this.screenSize === "md" ? a`<nys-button
                  variant="ghost"
                  prefixIcon="search"
                  id="nys-unavheader__searchbutton"
                  class="nys-unavheader__iconbutton"
                  @click="${this._toggleSearchDropdown}"
                ></nys-button>` : a`<nys-textinput
      ...
      ${this.screenSize === "md" || this.screenSize === "lg" || this.screenSize === "xl" ? a` <div
            class="nys-unavheader__trustbar ${this.trustbarVisible ? "show" : "hide"}"
          >
            <div class="nys-unavheader__trustcontent">
              <div class="nys-unavheader__trustcontentmessage">
...
m1([
  l({ type: Boolean, reflect: !0 })
], q.prototype, "trustbarVisible", 2);
m1([
  l({ type: Boolean, reflect: !0 })
], q.prototype, "searchDropdownVisible", 2);
m1([
  l({ type: Boolean, reflect: !0 })
], q.prototype, "languageVisible", 2);
m1([
  l({ type: Boolean, reflect: !0 })
], q.prototype, "isSearchFocused", 2);
m1([
  l({ type: Boolean, reflect: !0 })
], q.prototype, "hideTranslate", 2);
m1([
  l({ type: Boolean, reflect: !0 })
], q.prototype, "hideSearch", 2);
m1([
  l({ type: String })
], q.prototype, "screenSize", 1);
...
`;
var v0 = Object.defineProperty, B1 = (s, t, e, o) => {
  for (var n = void 0, r = s.length - 1, i; r >= 0; r--)
    (i = s[r]) && (n = i(t, e, n) || n);
  return n && v0(t, e, n), n;
};
const k5 = class k5 extends p {
  constructor() {
  ...
  firstUpdated() {
    var e;
    const t = (e = this.shadowRoot) == null ? void 0 : e.querySelector('slot[name="text"]');
  ...
  _handleSlotChange() {
    ...
    const o = (i = this.shadowRoot) == null ? void 0 : i.querySelector(
      ".nys-globalheader__content"
    ), n = (C = this.shadowRoot) == null ? void 0 : C.querySelector(
      ".nys-globalheader__content-mobile"
    );
    o && n && (o.innerHTML = "", n.innerHTML = "", e.forEach((c) => {
      if (c.nodeType === Node.ELEMENT_NODE) {
        const y = c.cloneNode(!0), v = c.cloneNode(!0);
        ["script", "iframe", "object", "embed"].forEach((B) => {
          y.querySelectorAll(B).forEach((N) => N.remove());
        }), o.appendChild(y), n.appendChild(v), c.remove();
      }
    }));
  }
  _toggleMobileMenu() {
        ...
        <div class="nys-globalheader__main-container">
          ...
          ${this.disableHomepageLink ? a`
                <div class="nys-globalheader__name-container">
                  ...
                  ${((e = this.agencyName) == null ? void 0 : e.trim().length) > 0 ? a`<div
              ...
              ` : a`<a
                href=${((n = this.homepageLink) == null ? void 0 : n.trim()) || window.location.origin}
              >
                <div class="nys-globalheader__name-container">
                  ${((r = this.appName) == null ? void 0 : r.trim().length) > 0 ? a`<div
                        class="nys-globalheader__appName nys-globalheader__name"
                      >
                        ${this.appName}
                      </div> ` : ""}
...
B1([
  l({ type: String })
], Y.prototype, "agencyName");
B1([
  l({ type: String })
], Y.prototype, "homepageLink");
B1([
  l({ type: Boolean })
], Y.prototype, "disableHomepageLink");
B1([
  u1()
], Y.prototype, "slotHasContent");
B1([
  u1()
], Y.prototype, "isMobileMenuOpen");
customElements.get("nys-globalheader") || customElements.define("nys-globalheader", Y);
const u0 = b`
  :host {
...
`;
var g0 = Object.defineProperty, v5 = (s, t, e, o) => {
  for (var n = void 0, r = s.length - 1, i; r >= 0; r--)
    (i = s[r]) && (n = i(t, e, n) || n);
  return n && g0(t, e, n), n;
};
const E5 = class E5 extends p {
  constructor() {
  ...
  _handleSlotChange() {
    ...
    const o = (i = this.shadowRoot) == null ? void 0 : i.querySelector(
      ".nys-globalfooter__content"
    ), n = e == null ? void 0 : e.some(
      (C) => C.tagName === "H4"
    );
    o && (o.classList.toggle("columns", n), o.classList.toggle("small", !n), o.innerHTML = "", e.forEach((C) => {
      if (C.nodeType === Node.ELEMENT_NODE) {
        const c = C.cloneNode(!0);
        ["script", "iframe", "object", "embed"].forEach((v) => {
          c.querySelectorAll(v).forEach((h) => h.remove());
        }), o.appendChild(c), C.remove();
      }
    }));
  }
  render() {
    ...
    return a`
      <footer class="nys-globalfooter">
        <div class="nys-globalfooter__main-container">
          ${this.disableHomepageLink ? a`<p class="nys-globalfooter__name">${this.agencyName}</p>` : a`<a
...
v5([
  l({ type: String })
], v1.prototype, "agencyName");
v5([
  l({ type: String })
], v1.prototype, "homepageLink");
v5([
  l({ type: Boolean })
], v1.prototype, "disableHomepageLink");
v5([
  u1()
], v1.prototype, "slotHasContent");
customElements.get("nys-globalfooter") || customElements.define("nys-globalfooter", v1);
const f0 = b`
  :host {
    /* Global Footer Styles */
...
`, b0 = `<svg xmlns="http://www.w3.org/2000/svg" width="91" height="55" viewBox="0 0 91 55" fill="none">
...
</svg>`, z5 = class z5 extends p {
  /**************** Functions ****************/
  _getNysLogo() {
    return new DOMParser().parseFromString(b0, "image/svg+xml").documentElement;
  }
  render() {
    return a`
...
z5.styles = f0;
let f5 = z5;
customElements.get("nys-unavfooter") || customElements.define("nys-unavfooter", f5);
export {
  P7 as NysAlert,
  I7 as NysAvatar,
  j7 as NysButton,
  Q7 as NysCheckbox,
  v1 as NysGlobalFooter,
  Y as NysGlobalHeader,
  s3 as NysIcon,
  d3 as NysRadiobutton,
  g3 as NysSelect,
  w3 as NysTextarea,
  M3 as NysTextinput,
  S3 as NysToggle,
