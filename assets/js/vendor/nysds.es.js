import { css as f, LitElement as p, html as i } from "lit";
...
`;
var k1 = Object.defineProperty, L1 = Object.getOwnPropertyDescriptor, w = (l, e, t, o) => {
  for (var s = o > 1 ? void 0 : o ? L1(e, t) : e, n = l.length - 1, a; n >= 0; n--)
    (a = l[n]) && (s = (o ? a(e, t, s) : a(s)) || s);
  return o && s && k1(e, t, s), s;
};
let S1 = 0;
var F;
const m = (F = class extends p {
  constructor() {
      ...
      t.trim() !== "" ? t : void 0
          ...
          >
            ...
            <div class="nys-alert__texts">
              ...
              ${this._slotHasContent ? i`<slot></slot>` : ((s = this.text) == null ? void 0 : s.trim().length) > 0 ? i`<p class="nys-alert__text">${this.text}</p>` : ""}
              ${this.primaryAction || this.secondaryAction ? i`<div class="nys-alert__actions">
                    ${this.primaryAction ? i`<a
                          href=${d(this.primaryAction || void 0)}
                          class="nys-alert__action nys-alert__primary"
                        >
                          ${this.primaryLabel}
                        </a>` : ""}
                    ${this.secondaryAction ? i`<a
                          href=${d(this.secondaryAction || void 0)}
            ...
            ${this.dismissible && this.type !== "emergency" ? i`<div class="close-container">
                  <nys-button
                    id="dismiss-btn"
                    variant="ghost"
                    prefixIcon="close"
                  ...
                  ></nys-button>
                </div>` : this.dismissible && this.type === "emergency" ? i`<div class="close-container">
                    <nys-button
                      id="dismiss-btn"
                      variant="ghost"
                      prefixIcon="close"
...
`;
var V1 = Object.defineProperty, z1 = Object.getOwnPropertyDescriptor, K = (l, e, t, o) => {
  for (var s = o > 1 ? void 0 : o ? z1(e, t) : e, n = l.length - 1, a; n >= 0; n--)
    (a = l[n]) && (s = (o ? a(e, t, s) : a(s)) || s);
  return o && s && V1(e, t, s), s;
};
let D1 = 0;
var G;
const N = (G = class extends p {
  constructor() {
  ...
  set shape(e) {
    this._shape = G.VALID_SHAPES.includes(
      e
  ...
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-avatar-${Date.now()}-${D1++}`);
  }
  render() {
    var e, t, o, s;
    return i`
      <label class="nys-avatar" id=${this.id}>
        <div class="nys-avatar__content">
          <div
            ...
            role=${d(this.image ? void 0 : "img")}
            aria-label=${d(this.image ? void 0 : this.label)}
          >
            ${((t = this.image) == null ? void 0 : t.length) > 0 ? i`<img
                  part="nys-avatar__image"
                  class="nys-avatar__image"
                  src=${this.image}
                  alt=${this.label}
                  loading=${this.lazy ? "lazy" : "eager"}
                />` : ((o = this.initials) == null ? void 0 : o.length) > 0 ? i`<span
                    part="nys-avatar__initials"
                    class="nys-avatar__initials"
                    aria-hidden="true"
                    >${this.initials}</span
                  >` : ((s = this.icon) == null ? void 0 : s.length) > 0 ? i`<div part="nys-avatar__icon">
                      <nys-icon
...
let H1 = N;
customElements.get("nys-avatar") || customElements.define("nys-avatar", H1);
const E1 = f`
  :host {
...
`;
var Z1 = Object.defineProperty, I1 = Object.getOwnPropertyDescriptor, _ = (l, e, t, o) => {
  for (var s = o > 1 ? void 0 : o ? I1(e, t) : e, n = l.length - 1, a; n >= 0; n--)
    (a = l[n]) && (s = (o ? a(e, t, s) : a(s)) || s);
  return o && s && Z1(e, t, s), s;
};
let A1 = 0;
var x;
const b = (x = class extends p {
  ...
  _handleKeydown(e) {
    (e.code === "Space" || e.code === "Enter") && (e.preventDefault(), this.disabled || this._manageFormAction(e));
  }
  render() {
    return i`
      ${this.href ? i`
            <div class="nys-button__linkwrapper">
              <a
                ...
                form=${d(this.form ? this.form : void 0)}
              ...
              >
                ${this.prefixIcon && this.variant !== "text" ? i`<slot name="prefix-icon">
                      <nys-icon size="16" name=${this.prefixIcon}></nys-icon>
                    </slot>` : ""}
                ${this.label ? i`<label class="nys-button__text">${this.label}</label>` : ""}
                ${this.suffixIcon && this.variant !== "text" ? i`<slot name="suffix-icon">
  ...
  "ghost",
  "text"
], x.VALID_TYPES = ["submit", "reset", "button"], x.styles = E1, x.formAssociated = !0, x);
_([
  r({ type: String })
], b.prototype, "id", 2);
_([
...
`;
var B1 = Object.defineProperty, U1 = Object.getOwnPropertyDescriptor, R = (l, e, t, o) => {
  for (var s = o > 1 ? void 0 : o ? U1(e, t) : e, n = l.length - 1, a; n >= 0; n--)
    (a = l[n]) && (s = (o ? a(e, t, s) : a(s)) || s);
  return o && s && B1(e, t, s), s;
};
let O1 = 0;
var q;
const E = (q = class extends p {
  // allows use of elementInternals' API
  constructor() {
  ...
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-checkbox-${Date.now()}-${O1++}`), this.addEventListener("change", this._handleCheckboxChange), this.addEventListener("invalid", this._handleInvalid);
  }
  disconnectedCallback() {
  ...
  _handleCheckboxChange(e) {
    const t = e, { name: o } = t.detail, n = Array.from(this.querySelectorAll("nys-checkbox")).filter((a) => a.checked).map((a) => a.value);
  ...
  async _manageCheckboxRequired() {
    if (this.required) {
      ...
      let s = !1;
      this.querySelectorAll("nys-checkbox").forEach((a) => {
        a.checked && (s = !0);
...
}, q.VALID_SIZES = ["sm", "md"], q.styles = b1, q.formAssociated = !0, q);
R([
  r({ type: String })
], E.prototype, "id", 2);
R([
...
let P1 = E;
customElements.get("nys-checkboxgroup") || customElements.define("nys-checkboxgroup", P1);
var N1 = Object.defineProperty, R1 = Object.getOwnPropertyDescriptor, S = (l, e, t, o) => {
  for (var s = o > 1 ? void 0 : o ? R1(e, t) : e, n = l.length - 1, a; n >= 0; n--)
    (a = l[n]) && (s = (o ? a(e, t, s) : a(s)) || s);
  return o && s && N1(e, t, s), s;
};
let T1 = 0;
var B;
const k = (B = class extends p {
  // allows use of elementInternals' API
  constructor() {
  ...
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-checkbox-${Date.now()}-${T1++}`), this.addEventListener("invalid", this._handleInvalid);
  }
  disconnectedCallback() {
  ...
  _handleChange(e) {
    ...
    this.checked = t, this.groupExist || this._internals.setFormValue(this.checked ? this.value : null), this._validate(), this.dispatchEvent(
  ...
  // Handle keydown for keyboard accessibility
  _handleKeydown(e) {
    e.code === "Space" && (e.preventDefault(), this.disabled || (this.checked = !this.checked, this._internals.setFormValue(this.checked ? this.value : null), this._manageRequire(), this.dispatchEvent(
      new CustomEvent("change", {
        detail: {
          checked: this.checked,
          name: this.name,
    ...
    return i`
      <div class="nys-checkbox">
        <label class="nys-checkbox__content">
          ...
          ${this.label && i` <div class="nys-checkbox__text">
            <div class="nys-checkbox__requiredwrapper">
              <label for=${this.id} class="nys-checkbox__label"
                >${this.label}</label
              >
              ${this.required ? i`<label class="nys-checkbox__required">*</label>` : ""}
            </div>
...
}, B.VALID_SIZES = ["sm", "md"], B.styles = b1, B.formAssociated = !0, B);
S([
  r({ type: Boolean, reflect: !0 })
...
let F1 = k;
customElements.get("nys-checkbox") || customElements.define("nys-checkbox", F1);
const G1 = f`
  :host {
...
`;
var j1 = Object.defineProperty, d1 = (l, e, t, o) => {
  for (var s = void 0, n = l.length - 1, a; n >= 0; n--)
    (a = l[n]) && (s = a(e, t, s) || s);
  return s && j1(e, t, s), s;
};
const l1 = class l1 extends p {
  // allows use of elementInternals' API
  constructor() {
...
l1.styles = G1, l1.formAssociated = !0;
let t1 = l1;
d1([
  r({ type: Boolean })
], t1.prototype, "showError");
d1([
  r({ type: String })
], t1.prototype, "errorMessage");
d1([
  r({ type: Boolean, reflect: !0 })
], t1.prototype, "showDivider");
customElements.get("nys-errormessage") || customElements.define("nys-errormessage", t1);
const Y1 = {
...
`;
var W1 = Object.defineProperty, X1 = Object.getOwnPropertyDescriptor, o1 = (l, e, t, o) => {
  for (var s = o > 1 ? void 0 : o ? X1(e, t) : e, n = l.length - 1, a; n >= 0; n--)
    (a = l[n]) && (s = (o ? a(e, t, s) : a(s)) || s);
  return o && s && W1(e, t, s), s;
}, j;
const J = (j = class extends p {
  constructor() {
...
let J1 = J;
customElements.get("nys-icon") || customElements.define("nys-icon", J1);
const Q1 = f`
  :host {
    /* Label Typography */
...
`;
var e2 = Object.defineProperty, c1 = (l, e, t, o) => {
  for (var s = void 0, n = l.length - 1, a; n >= 0; n--)
    (a = l[n]) && (s = a(e, t, s) || s);
  return s && e2(e, t, s), s;
};
const C1 = class C1 extends p {
  constructor() {
    ...
    return i`
      <div class="nys-label">
        <label for=${this.id} class="nys-label__label"
          >${this.label}
          ${this.flag === "required" ? i`<label class="nys-label__required">*</label>` : ""}
          ${this.flag === "optional" ? i`<label class="nys-label__optional">(Optional)</label>` : ""}</label
        >
...
customElements.get("nys-label") || customElements.define("nys-label", W);
const _1 = f`
  :host {
...
`;
var t2 = Object.defineProperty, s2 = Object.getOwnPropertyDescriptor, Z = (l, e, t, o) => {
  for (var s = o > 1 ? void 0 : o ? s2(e, t) : e, n = l.length - 1, a; n >= 0; n--)
    (a = l[n]) && (s = (o ? a(e, t, s) : a(s)) || s);
  return o && s && t2(e, t, s), s;
};
let o2 = 0;
var U;
const z = (U = class extends p {
  // allows use of elementInternals' API
  constructor() {
  ...
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-radiogroup-${Date.now()}-${o2++}`), this.addEventListener("change", this._handleRadioButtonChange), this.addEventListener("invalid", this._handleInvalid);
  }
  disconnectedCallback() {
  ...
  updated(e) {
    (e.has("required") || e.has("selectedValue")) && this._manageRequire(), e.has("size") && this._updateRadioButtonsSize();
  }
  // This callback is automatically called when the parent form is reset.
  formResetCallback() {
...
}, U.VALID_SIZES = ["sm", "md"], U.styles = _1, U.formAssociated = !0, U);
Z([
  r({ type: String })
], z.prototype, "id", 2);
Z([
...
let r2 = z;
customElements.get("nys-radiogroup") || customElements.define("nys-radiogroup", r2);
var n2 = Object.defineProperty, a2 = Object.getOwnPropertyDescriptor, T = (l, e, t, o) => {
  for (var s = o > 1 ? void 0 : o ? a2(e, t) : e, n = l.length - 1, a; n >= 0; n--)
    (a = l[n]) && (s = (o ? a(e, t, s) : a(s)) || s);
  return o && s && n2(e, t, s), s;
};
let i2 = 0;
var h;
const I = (h = class extends p {
  constructor() {
  ...
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-radiobutton-${Date.now()}-${i2++}`), this.checked && (h.buttonGroup[this.name] && (h.buttonGroup[this.name].checked = !1, h.buttonGroup[this.name].requestUpdate()), h.buttonGroup[this.name] = this);
  }
  updated(e) {
    e.has("checked") && this.checked && h.buttonGroup[this.name] !== this && (h.buttonGroup[this.name] && (h.buttonGroup[this.name].checked = !1, h.buttonGroup[this.name].requestUpdate()), h.buttonGroup[this.name] = this);
  }
  /******************** Function ********************/
  // This helper function is called to perform the element's native validation.
  checkValidity() {
  ...
  _handleChange() {
    this.checked || (h.buttonGroup[this.name] && (h.buttonGroup[this.name].checked = !1, h.buttonGroup[this.name].requestUpdate()), h.buttonGroup[this.name] = this, this.checked = !0, this.dispatchEvent(
      new CustomEvent("change", {
  ...
  // Handle keydown for keyboard accessibility
  _handleKeydown(e) {
    e.code === "Space" && (e.preventDefault(), !this.disabled && !this.checked && (h.buttonGroup[this.name] && (h.buttonGroup[this.name].checked = !1, h.buttonGroup[this.name].requestUpdate()), h.buttonGroup[this.name] = this, this.checked = !0, this.dispatchEvent(
      new CustomEvent("change", {
        detail: {
          checked: this.checked,
          name: this.name,
    ...
    return i`
      <label class="nys-radiobutton">
        <input
          ...
          @keydown="${this._handleKeydown}"
        />
        ${this.label && i` <div class="nys-radiobutton__text">
...
}, h.VALID_SIZES = ["sm", "md"], h.buttonGroup = {}, h.styles = _1, h);
T([
  r({ type: Boolean, reflect: !0 })
...
let l2 = I;
customElements.get("nys-radiobutton") || customElements.define("nys-radiobutton", l2);
const c2 = f`
  :host {
...
`;
var h2 = Object.defineProperty, n1 = (l, e, t, o) => {
  for (var s = void 0, n = l.length - 1, a; n >= 0; n--)
    (a = l[n]) && (s = a(e, t, s) || s);
  return s && h2(e, t, s), s;
};
...
customElements.define("nys-option", Q);
var d2 = Object.defineProperty, y2 = Object.getOwnPropertyDescriptor, $ = (l, e, t, o) => {
  for (var s = o > 1 ? void 0 : o ? y2(e, t) : e, n = l.length - 1, a; n >= 0; n--)
    (a = l[n]) && (s = (o ? a(e, t, s) : a(s)) || s);
  return o && s && d2(e, t, s), s;
};
let C2 = 0;
var O;
const L = (O = class extends p {
  // allows use of elementInternals' API
  constructor() {
  ...
  set width(e) {
    this._width = O.VALID_WIDTHS.includes(
      e
    ) ? e : "full";
  }
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-select-${Date.now()}-${C2++}`), this.addEventListener("invalid", this._handleInvalid);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), this.removeEventListener("invalid", this._handleInvalid);
  }
  ...
  _handleSlotChange() {
    ...
    if (!e || !t) return;
    t.querySelectorAll("option:not([hidden])").forEach((a) => a.remove()), e.assignedElements({ flatten: !0 }).forEach((a) => {
      var c;
      if (a instanceof Q) {
        const u = document.createElement("option");
        u.value = a.value, u.textContent = a.label || ((c = a.textContent) == null ? void 0 : c.trim()) || "", u.disabled = a.disabled, u.selected = a.selected, t.appendChild(u);
      }
    });
  }
  /********************** Form Integration **********************/
...
}, O.VALID_WIDTHS = ["sm", "md", "lg", "full"], O.styles = c2, O.formAssociated = !0, O);
$([
  r({ type: String })
], L.prototype, "id", 2);
$([
...
let u2 = L;
customElements.get("nys-select") || customElements.define("nys-select", u2);
const p2 = f`
  :host {
    /* Anything that can be overridden should be defined here */
...
`;
var g2 = Object.defineProperty, v2 = Object.getOwnPropertyDescriptor, v = (l, e, t, o) => {
  for (var s = o > 1 ? void 0 : o ? v2(e, t) : e, n = l.length - 1, a; n >= 0; n--)
    (a = l[n]) && (s = (o ? a(e, t, s) : a(s)) || s);
  return o && s && g2(e, t, s), s;
};
let f2 = 0;
var M;
const g = (M = class extends p {
  // allows use of elementInternals' API
  constructor() {
  ...
  set resize(e) {
    this._resize = M.VALID_RESIZE.includes(
      e
    ) ? e : "vertical";
  }
  updated(e) {
    e.has("width") && (this.width = M.VALID_WIDTHS.includes(this.width) ? this.width : "full"), e.has("rows") && (this.rows = this.rows ?? 4);
  }
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-textarea-${Date.now()}-${f2++}`), this.addEventListener("invalid", this._handleInvalid);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), this.removeEventListener("invalid", this._handleInvalid);
  }
...
}, M.VALID_WIDTHS = ["sm", "md", "lg", "full"], M.VALID_RESIZE = ["vertical", "none"], M.styles = p2, M.formAssociated = !0, M);
v([
  r({ type: String })
], g.prototype, "id", 2);
v([
...
let b2 = g;
customElements.get("nys-textarea") || customElements.define("nys-textarea", b2);
const _2 = f`
  :host {
    /* Anything that can be overridden should be defined here */
...
`;
var m2 = Object.defineProperty, x2 = Object.getOwnPropertyDescriptor, C = (l, e, t, o) => {
  for (var s = o > 1 ? void 0 : o ? x2(e, t) : e, n = l.length - 1, a; n >= 0; n--)
    (a = l[n]) && (s = (o ? a(e, t, s) : a(s)) || s);
  return o && s && m2(e, t, s), s;
};
let w2 = 0;
var V;
const y = (V = class extends p {
  // allows use of elementInternals' API
  constructor() {
  ...
  updated(e) {
    e.has("width") && (this.width = V.VALID_WIDTHS.includes(this.width) ? this.width : "full");
  }
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-textinput-${Date.now()}-${w2++}`), this._originalErrorMessage = this.errorMessage, this.addEventListener("invalid", this._handleInvalid);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), this.removeEventListener("invalid", this._handleInvalid);
  }
  ...
  render() {
    return i`
      ...
      this.placeholder ? this.placeholder : void 0
            ...
            min=${d(this.min !== "" ? this.min : void 0)}
            maxlength=${d(
      this.maxlength !== "" ? this.maxlength : void 0
    )}
            step=${d(this.step !== "" ? this.step : void 0)}
            max=${d(this.max !== "" ? this.max : void 0)}
            form=${d(this.form ? this.form : void 0)}
            @input=${this._handleInput}
            @focus="${this._handleFocus}"
            @blur="${this._handleBlur}"
  ...
  "text",
  "url"
], V.VALID_WIDTHS = ["sm", "md", "lg", "full"], V.styles = _2, V.formAssociated = !0, V);
C([
  r({ type: String })
], y.prototype, "id", 2);
C([
...
let k2 = y;
customElements.get("nys-textinput") || customElements.define("nys-textinput", k2);
const L2 = f`
  :host {
...
`;
var S2 = Object.defineProperty, $2 = Object.getOwnPropertyDescriptor, A = (l, e, t, o) => {
  for (var s = o > 1 ? void 0 : o ? $2(e, t) : e, n = l.length - 1, a; n >= 0; n--)
    (a = l[n]) && (s = (o ? a(e, t, s) : a(s)) || s);
  return o && s && S2(e, t, s), s;
};
let M2 = 0;
var P;
const D = (P = class extends p {
  // allows use of elementInternals' API
  constructor() {
  ...
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-toggle-${Date.now()}-${M2++}`);
  }
  /********************** Form Integration **********************/
  ...
  _handleKeyDown(e) {
    !this.disabled && (e.key === " " || e.key === "Enter") && (e.preventDefault(), this.checked = !this.checked, this.dispatchEvent(
      new CustomEvent("change", {
        detail: { checked: this.checked },
        bubbles: !0,
        composed: !0
...
}, P.VALID_SIZES = ["sm", "md"], P.styles = L2, P.formAssociated = !0, P);
A([
  r({ type: String })
], D.prototype, "id", 2);
A([
...
let V2 = D;
customElements.get("nys-toggle") || customElements.define("nys-toggle", V2);
const z2 = f`
  :host {
...
`, D2 = `<svg xmlns="http://www.w3.org/2000/svg" width="91" height="55" viewBox="0 0 91 55" fill="none">
...
var H2 = Object.defineProperty, E2 = Object.getOwnPropertyDescriptor, e1 = (l, e, t, o) => {
  for (var s = o > 1 ? void 0 : o ? E2(e, t) : e, n = l.length - 1, a; n >= 0; n--)
    (a = l[n]) && (s = (o ? a(e, t, s) : a(s)) || s);
  return o && s && H2(e, t, s), s;
};
const u1 = class u1 extends p {
  ...
  get screenSize() {
    ...
    return e < 480 ? "xs" : e < 768 ? "sm" : e < 1024 ? "md" : e < 1280 ? "lg" : "xl";
  }
  _getNysLogo() {
    return new DOMParser().parseFromString(D2, "image/svg+xml").documentElement;
  }
  _toggleTrustbar() {
  ...
  _handleSearchKeyup(e) {
    if (e.key === "Escape" && (this._handleSearchBlur(), e.target.blur()), e.key === "Enter") {
      ...
      t !== "" && (window.location.href = `https://search.its.ny.gov/search/search.html?btnG=Search&client=default_frontend&output=xml_no_dtd&proxystylesheet=default_frontend&ulang=en&sort=date:D:L:d1&entqr=3&entqrm=0&wc=200&wc_mc=1&oe=UTF-8&ie=UTF-8&ud=1&site=default_collection&q=${t}+inurl:${window.location.hostname}&site=default_collection`);
    }
  }
  _updateScreenSize() {
    this.requestUpdate();
  ...
  render() {
    return i`
      ${this.screenSize === "xs" || this.screenSize === "sm" ? i` <div class="nys-unavheader__toptrustbar">
              ...
              ${this.trustbarVisible ? i`<nys-button
      ...
      <header class="nys-unavheader" id="nys-universal-navigation">
        <div class="nys-unavheader__maincontent">
          <div class="nys-unavheader__left">
            ...
            >
            ${this.screenSize === "md" || this.screenSize === "lg" || this.screenSize === "xl" ? i` <div class="nys-unavheader__officialmessage">
                  <label id="nys-unavheader__official"
                    >An official website of New York State</label
                  >
                  <nys-button
          ...
          <div class="nys-unavheader__right">
            ${!this.isSearchFocused && !this.hideTranslate ? i`<div class="nys-unavheader__translatewrapper">
                  ${this.screenSize === "xs" || this.screenSize === "sm" || this.screenSize === "md" ? i`<nys-button
                        variant="ghost"
                        prefixIcon="language"
                        id="nys-unavheader__translate"
                        class="nys-unavheader__iconbutton"
                        @click="${this._toggleLanguageList}"
                      ></nys-button>` : i`<nys-button
                        variant="ghost"
                        label="Translate"
      ...
      ([e, t]) => i`<a
            ...
            ${this.hideSearch ? null : this.screenSize === "xs" || this.screenSize === "sm" || this.screenSize === "md" ? i`<nys-button
                    variant="ghost"
                    prefixIcon="search"
                    id="nys-unavheader__searchbutton"
                    class="nys-unavheader__iconbutton"
                    @click="${this._toggleSearchDropdown}"
                  ></nys-button>` : i`<nys-textinput
      ...
      ${this.screenSize === "md" || this.screenSize === "lg" || this.screenSize === "xl" ? i` <div
            class="nys-unavheader__trustbar ${this.trustbarVisible ? "show" : "hide"}"
          >
            <div class="nys-unavheader__trustcontent">
              <div class="nys-unavheader__trustcontentmessage">
...
e1([
  r({ type: Boolean })
], H.prototype, "trustbarVisible", 2);
e1([
  r({ type: Boolean })
], H.prototype, "searchDropdownVisible", 2);
e1([
  r({ type: Boolean })
], H.prototype, "languageVisible", 2);
e1([
  r({ type: Boolean })
], H.prototype, "isSearchFocused", 2);
e1([
  r({ type: Boolean })
], H.prototype, "hideTranslate", 2);
e1([
  r({ type: Boolean })
], H.prototype, "hideSearch", 2);
e1([
  r({ type: String, reflect: !0 })
], H.prototype, "screenSize", 1);
customElements.get("nys-unavheader") || customElements.define("nys-unavheader", H);
const Z2 = f`
  :host {
...
`;
var I2 = Object.defineProperty, a1 = (l, e, t, o) => {
  for (var s = void 0, n = l.length - 1, a; n >= 0; n--)
    (a = l[n]) && (s = a(e, t, s) || s);
  return s && I2(e, t, s), s;
};
const p1 = class p1 extends p {
  constructor() {
  ...
  _handleSlotChange() {
    ...
    if (!e) return;
    const t = e == null ? void 0 : e.assignedNodes({ flatten: !0 }).filter((u) => u.nodeType === Node.ELEMENT_NODE);
    this.slotHasContent = t.length > 0;
    const o = (a = this.shadowRoot) == null ? void 0 : a.querySelector(
      ".nys-globalheader__content"
    ), s = (c = this.shadowRoot) == null ? void 0 : c.querySelector(
      ".nys-globalheader__content-mobile"
    );
    o && s && (o.innerHTML = "", s.innerHTML = "", t.forEach((u) => {
      if (u.nodeType === Node.ELEMENT_NODE) {
        const i1 = u.cloneNode(!0), r1 = u.cloneNode(!0);
        ["script", "iframe", "object", "embed"].forEach((m1) => {
          i1.querySelectorAll(m1).forEach((x1) => x1.remove());
        }), o.appendChild(i1), s.appendChild(r1), u.remove();
      }
    }));
  }
  _toggleMobileMenu() {
    ...
    return i`
      <header class="nys-globalheader">
        <div class="nys-globalheader__main-container">
          ${this.slotHasContent ? i` <div class="nys-globalheader__button-container">
                <button
          ...
          ${(e = this.homepageLink) != null && e.trim() ? i`<a
                class="nys-globalheader__name-container-link"
                href=${(n = this.homepageLink) == null ? void 0 : n.trim()}
              >
                <div class="nys-globalheader__name-container">
                  ${((a = this.appName) == null ? void 0 : a.trim().length) > 0 ? i`<div
                        class="nys-globalheader__appName nys-globalheader__name"
                      >
                        ${this.appName}
                      </div> ` : ""}
                  ${((c = this.agencyName) == null ? void 0 : c.trim().length) > 0 ? i`<div
                ...
                <div class="nys-globalheader__name-container">
                  ${((t = this.appName) == null ? void 0 : t.trim().length) > 0 ? i`<div
                        class="nys-globalheader__appName nys-globalheader__name"
                      >
                        ${this.appName}
                      </div> ` : ""}
                  ${((o = this.agencyName) == null ? void 0 : o.trim().length) > 0 ? i`<div
              ...
              `}
          ${this.slotHasContent ? i`<div class="nys-globalheader__content">
                <slot
...
`;
var q2 = Object.defineProperty, y1 = (l, e, t, o) => {
  for (var s = void 0, n = l.length - 1, a; n >= 0; n--)
    (a = l[n]) && (s = a(e, t, s) || s);
  return s && q2(e, t, s), s;
};
  ...
  _handleSlotChange() {
    ...
    o && (o.classList.toggle("columns", s), o.classList.toggle("small", !s), o.innerHTML = "", t.forEach((c) => {
      if (c.nodeType === Node.ELEMENT_NODE) {
        ...
        ["script", "iframe", "object", "embed"].forEach((r1) => {
          u.querySelectorAll(r1).forEach((f1) => f1.remove());
        }), o.appendChild(u), c.remove();
      }
    }));
  }
  render() {
    ...
    return i`
      <footer class="nys-globalfooter">
        <div class="nys-globalfooter__main-container">
          ${(e = this.homepageLink) != null && e.trim() ? i`<a href=${(t = this.homepageLink) == null ? void 0 : t.trim()}>
                <p class="nys-globalfooter__name">${this.agencyName}</p>
              </a>` : i`<p class="nys-globalfooter__name">${this.agencyName}</p>`}
...
customElements.get("nys-globalfooter") || customElements.define("nys-globalfooter", s1);
const B2 = f`
  :host {
    /* Global Footer Styles */
...
v1.styles = B2;
let h1 = v1;
customElements.get("nys-unavfooter") || customElements.define("nys-unavfooter", h1);
export {
  $1 as NysAlert,
  H1 as NysAvatar,
  q1 as NysButton,
  F1 as NysCheckbox,
  P1 as NysCheckboxgroup,
  t1 as NysErrorMessage,
  s1 as NysGlobalFooter,
  Y as NysGlobalHeader,
  J1 as NysIcon,
  W as NysLabel,
  Q as NysOption,
  l2 as NysRadiobutton,
  r2 as NysRadiogroup,
  u2 as NysSelect,
  b2 as NysTextarea,
  k2 as NysTextinput,
