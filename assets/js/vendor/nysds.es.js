...
z1([
  r({ type: String })
], l1.prototype, "heading");
z1([
  r({ type: Boolean, reflect: !0 })
], l1.prototype, "expanded");
z1([
  r({ type: Boolean, reflect: !0 })
], l1.prototype, "bordered");
z1([
...
const j1 = class j1 extends u {
  ...
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-avatar-${Date.now()}-${Le++}`);
  }
...
var Se = Object.defineProperty, q1 = (a, e, t, o) => {
  for (var s = void 0, n = a.length - 1, i; n >= 0; n--)
    (i = a[n]) && (s = i(e, t, s) || s);
  return s && Se(e, t, s), s;
};
...
}, $.styles = p(Ee), $.VALID_SIZES = ["sm", "md", "lg"], $.VALID_VARIANTS = [
  "filled",
  "outline",
  "ghost",
  "text"
...
const o1 = (P = class extends u {
  ...
  resolveIcon(e) {
    return e === !0 ? P.DEFAULT_ICONS[this.intent] ?? "info" : typeof e == "string" && e.trim() !== "" ? e : null;
  }
  render() {
...
const E = (G = class extends u {
  ...
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-checkbox-${Date.now()}-${Pe++}`), this.addEventListener("nys-change", this._handleCheckboxChange), this.addEventListener("invalid", this._handleInvalid);
  }
  disconnectedCallback() {
...
}, G.styles = p(le), G.VALID_SIZES = ["sm", "md"], G.formAssociated = !0, G);
A([
  r({ type: String, reflect: !0 })
], E.prototype, "id", 2);
A([
...
D1([
  r({ type: Number, reflect: !0 })
], c1.prototype, "currentPage");
D1([
  r({ type: Number, reflect: !0 })
], c1.prototype, "totalPages");
D1([
  r({ type: Boolean, reflect: !0 })
], c1.prototype, "_twoBeforeLast");
customElements.get("nys-pagination") || customElements.define("nys-pagination", c1);
...
var bt = Object.defineProperty, _t = Object.getOwnPropertyDescriptor, D = (a, e, t, o) => {
...
}, Q.styles = p(ce), Q.VALID_SIZES = ["sm", "md"], Q.formAssociated = !0, Q);
D([
  r({ type: String, reflect: !0 })
], L.prototype, "id", 2);
D([
...
var $t = Object.defineProperty, V1 = (a, e, t, o) => {
  for (var s = void 0, n = a.length - 1, i; n >= 0; n--)
    (i = a[n]) && (s = i(e, t, s) || s);
  return s && $t(e, t, s), s;
};
...
const V = (J = class extends u {
  ...
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-select-${Date.now()}-${Dt++}`), this._originalErrorMessage = this.errorMessage ?? "", this.addEventListener("invalid", this._handleInvalid);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), this.removeEventListener("invalid", this._handleInvalid);
  }
      ...
      if (n.tagName === "OPTGROUP") {
        ...
        i.label = n.label, n.disabled && (i.disabled = !0), Array.from(n.children).forEach((c) => {
          if (c instanceof d1) {
            ...
            h.value = c.value, h.textContent = c.label || c.textContent?.trim() || "", h.disabled = c.disabled, h.selected = c.selected, i.appendChild(h);
...
}, J.styles = p(St), J.VALID_WIDTHS = ["sm", "md", "lg", "full"], J.formAssociated = !0, J);
B([
  r({ type: String, reflect: !0 })
], V.prototype, "id", 2);
B([
...
const C = (N = class extends u {
  ...
  async updated(e) {
    await Promise.resolve(), e.has("width") && (this.width = N.VALID_WIDTHS.includes(this.width) ? this.width : "full"), e.has("rows") && (this.rows = this.rows ?? 4);
  }
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-textarea-${Date.now()}-${Pt++}`), this.addEventListener("invalid", this._handleInvalid);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), this.removeEventListener("invalid", this._handleInvalid);
  }
...
const v = (F = class extends u {
  ...
  async updated(e) {
    if (e.has("width") && (await Promise.resolve(), this.width = F.VALID_WIDTHS.includes(this.width) ? this.width : "full"), e.has("disabled") && (this._validateButtonSlot("startButton"), this._validateButtonSlot("endButton")), e.has("type")) {
...
}, e1.styles = p(jt), e1.VALID_SIZES = ["sm", "md"], e1.formAssociated = !0, e1);
T([
  r({ type: String, reflect: !0 })
], O.prototype, "id", 2);
T([
    ...
    if (o && s) {
      ...
      t.forEach((i) => {
        if (i.nodeType === Node.ELEMENT_NODE) {
          ...
          const M = (j) => {
            const R = Array.from(j.querySelectorAll("a"));
            let $1 = {
              li: null,
              length: 0
            };
...
var a2 = Object.defineProperty, N1 = (a, e, t, o) => {
  for (var s = void 0, n = a.length - 1, i; n >= 0; n--)
    (i = a[n]) && (s = i(e, t, s) || s);
  return s && a2(e, t, s), s;
};
