...
const H2 = (r) => new Z2(typeof r == "string" ? r : r + "", void 0, d2), V2 = (r, t) => {
  if (b5) r.adoptedStyleSheets = t.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet);
  else for (const e of t) {
    const o = document.createElement("style"), n = e5.litNonce;
    n !== void 0 && o.setAttribute("nonce", n), o.textContent = e.cssText, r.appendChild(o);
  }
}, P5 = b5 ? (r) => r : (r) => r instanceof CSSStyleSheet ? ((t) => {
  let e = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: S2, defineProperty: k2, getOwnPropertyDescriptor: E2, getOwnPropertyNames: z2, getOwnPropertySymbols: A2, getPrototypeOf: P2 } = Object, x1 = globalThis, B5 = x1.trustedTypes, B2 = B5 ? B5.emptyScript : "", O5 = x1.reactiveElementPolyfillSupport, G1 = (r, t) => r, i5 = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? B2 : null;
      break;
  ...
  return e;
} }, _5 = (r, t) => !S2(r, t), U5 = { attribute: !0, type: String, converter: i5, reflect: !1, hasChanged: _5 };
...
let O1 = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, e, o) {
    const { get: n, set: s } = E2(this.prototype, t) ?? { get() {
      return this[e];
    }, set(i) {
      this[e] = i;
    } };
    return { get() {
      ...
      s.call(this, i), this.requestUpdate(t, C, o);
  ...
  _$AK(t, e) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const i = n.getPropertyOptions(s), C = typeof i.converter == "function" ? { fromAttribute: i.converter } : ((o = i.converter) == null ? void 0 : o.fromAttribute) !== void 0 ? i.converter : i5;
      this._$Em = s, this[s] = C.fromAttribute(e, i.type), this._$Em = null;
    }
  }
  requestUpdate(t, e, o) {
    if (t !== void 0) {
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (n.size > 0) for (const [s, i] of n) i.wrapped !== !0 || this._$AL.has(s) || this[s] === void 0 || this.P(s, this[s], i);
    }
    let e = !1;
    const o = this._$AL;
    try {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const O2 = { attribute: !0, type: String, converter: i5, reflect: !1, hasChanged: _5 }, U2 = (r = O2, t, e) => {
  const { kind: o, metadata: n } = e;
  let s = globalThis.litPropertyMetadata.get(n);
  if (s === void 0 && globalThis.litPropertyMetadata.set(n, s = /* @__PURE__ */ new Map()), s.set(e.name, r), o === "accessor") {
    const { name: i } = e;
    return { set(C) {
      const c = t.get.call(this);
      t.set.call(this, C), this.requestUpdate(i, c, r);
    }, init(C) {
  ...
  if (o === "setter") {
    ...
    return function(C) {
      const c = this[i];
      t.call(this, C), this.requestUpdate(i, c, r);
    };
  }
  throw Error("Unsupported decorator location: " + o);
};
function V1(r) {
  return (t, e) => typeof e == "object" ? U2(r, t, e) : ((o, n, s) => {
...
`;
var I2 = Object.defineProperty, T2 = Object.getOwnPropertyDescriptor, S1 = (r, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? T2(t, e) : t, s = r.length - 1, i; s >= 0; s--)
    (i = r[s]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && I2(t, e, n), n;
}, U1;
const g1 = (U1 = class extends v {
  constructor() {
  ...
  getIcon() {
    const r = D2[this.name], t = !!this.label;
    if (!r) return null;
...
let q2 = class {
  ...
  get styleSheet() {
    ...
    if (w5 && r === void 0) {
      ...
      e && (r = D5.get(t)), r === void 0 && ((this.o = r = new CSSStyleSheet()).replaceSync(this.cssText), e && D5.set(t, r));
    }
    return r;
  }
  toString() {
...
const j2 = (r) => new q2(typeof r == "string" ? r : r + "", void 0, y2), G2 = (r, t) => {
  if (w5) r.adoptedStyleSheets = t.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet);
  else for (const e of t) {
    const o = document.createElement("style"), n = o5.litNonce;
    n !== void 0 && o.setAttribute("nonce", n), o.textContent = e.cssText, r.appendChild(o);
  }
}, N5 = w5 ? (r) => r : (r) => r instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const o of t.cssRules) e += o.cssText;
  return j2(e);
})(r) : r;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: F2, defineProperty: Y2, getOwnPropertyDescriptor: W2, getOwnPropertyNames: K2, getOwnPropertySymbols: J2, getPrototypeOf: X2 } = Object, L1 = globalThis, I5 = L1.trustedTypes, Q2 = I5 ? I5.emptyScript : "", T5 = L1.reactiveElementPolyfillSupport, F1 = (r, t) => r, l5 = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? Q2 : null;
      break;
  ...
  return e;
} }, m5 = (r, t) => !F2(r, t), R5 = { attribute: !0, type: String, converter: l5, reflect: !1, hasChanged: m5 };
...
let D1 = class extends HTMLElement {
  ...
  static createProperty(t, e = R5) {
    if (e.state && (e.attribute = !1), this._$Ei(), this.elementProperties.set(t, e), !e.noAccessor) {
      const o = Symbol(), n = this.getPropertyDescriptor(t, o, e);
      n !== void 0 && Y2(this.prototype, t, n);
    }
  }
  static getPropertyDescriptor(t, e, o) {
    const { get: n, set: s } = W2(this.prototype, t) ?? { get() {
      return this[e];
    }, set(i) {
      this[e] = i;
    } };
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      const o = new Set(t.flat(1 / 0).reverse());
      for (const n of o) e.unshift(N5(n));
    } else t !== void 0 && e.push(N5(t));
    return e;
  }
  static _$Eu(t, e) {
    const o = e.attribute;
  ...
  _$AK(t, e) {
    ...
    const n = this.constructor, s = n._$Eh.get(t);
    if (s !== void 0 && this._$Em !== s) {
      const i = n.getPropertyOptions(s), C = typeof i.converter == "function" ? { fromAttribute: i.converter } : ((o = i.converter) == null ? void 0 : o.fromAttribute) !== void 0 ? i.converter : l5;
      this._$Em = s, this[s] = C.fromAttribute(e, i.type), this._$Em = null;
    }
  }
  requestUpdate(t, e, o) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const t7 = { attribute: !0, type: String, converter: l5, reflect: !1, hasChanged: m5 }, e7 = (r = t7, t, e) => {
  const { kind: o, metadata: n } = e;
  let s = globalThis.litPropertyMetadata.get(n);
  if (s === void 0 && globalThis.litPropertyMetadata.set(n, s = /* @__PURE__ */ new Map()), s.set(e.name, r), o === "accessor") {
    const { name: i } = e;
...
function H(r) {
  return (t, e) => typeof e == "object" ? e7(r, t, e) : ((o, n, s) => {
    const i = n.hasOwnProperty(s);
    return n.constructor.createProperty(s, i ? { ...o, wrapped: !0 } : o), i ? Object.getOwnPropertyDescriptor(n, s) : void 0;
  })(r, t, e);
}
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const n5 = globalThis, x5 = n5.ShadowRoot && (n5.ShadyCSS === void 0 || n5.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, v2 = Symbol(), q5 = /* @__PURE__ */ new WeakMap();
let n7 = class {
  constructor(r, t, e) {
    if (this._$cssResult$ = !0, e !== v2) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
    this.cssText = r, this.t = t;
  }
  get styleSheet() {
    let r = this.o;
    ...
    if (x5 && r === void 0) {
      const e = t !== void 0 && t.length === 1;
      e && (r = q5.get(t)), r === void 0 && ((this.o = r = new CSSStyleSheet()).replaceSync(this.cssText), e && q5.set(t, r));
    }
    return r;
  }
  toString() {
...
const r7 = (r) => new n7(typeof r == "string" ? r : r + "", void 0, v2), s7 = (r, t) => {
  if (x5) r.adoptedStyleSheets = t.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet);
  else for (const e of t) {
    const o = document.createElement("style"), n = n5.litNonce;
    n !== void 0 && o.setAttribute("nonce", n), o.textContent = e.cssText, r.appendChild(o);
  }
}, j5 = x5 ? (r) => r : (r) => r instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const o of t.cssRules) e += o.cssText;
  return r7(e);
})(r) : r;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: i7, defineProperty: l7, getOwnPropertyDescriptor: a7, getOwnPropertyNames: C7, getOwnPropertySymbols: c7, getPrototypeOf: h7 } = Object, M1 = globalThis, G5 = M1.trustedTypes, d7 = G5 ? G5.emptyScript : "", F5 = M1.reactiveElementPolyfillSupport, Y1 = (r, t) => r, a5 = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? d7 : null;
      break;
  ...
  return e;
} }, L5 = (r, t) => !i7(r, t), Y5 = { attribute: !0, type: String, converter: a5, reflect: !1, hasChanged: L5 };
...
let N1 = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, e, o) {
    const { get: n, set: s } = a7(this.prototype, t) ?? { get() {
      return this[e];
    }, set(i) {
      this[e] = i;
    } };
  ...
  static getPropertyOptions(t) {
    return this.elementProperties.get(t) ?? Y5;
  }
  static _$Ei() {
  ...
  createRenderRoot() {
    const t = this.shadowRoot ?? this.attachShadow(this.constructor.shadowRootOptions);
    return s7(t, this.constructor.elementStyles), t;
  }
  connectedCallback() {
    var t;
    this.renderRoot ?? (this.renderRoot = this.createRenderRoot()), this.enableUpdating(!0), (t = this._$EO) == null || t.forEach((e) => {
  ...
  _$AK(t, e) {
    ...
    const n = this.constructor, s = n._$Eh.get(t);
    if (s !== void 0 && this._$Em !== s) {
      const i = n.getPropertyOptions(s), C = typeof i.converter == "function" ? { fromAttribute: i.converter } : ((o = i.converter) == null ? void 0 : o.fromAttribute) !== void 0 ? i.converter : a5;
      this._$Em = s, this[s] = C.fromAttribute(e, i.type), this._$Em = null;
    }
  }
  requestUpdate(t, e, o) {
...
N1.elementStyles = [], N1.shadowRootOptions = { mode: "open" }, N1[Y1("elementProperties")] = /* @__PURE__ */ new Map(), N1[Y1("finalized")] = /* @__PURE__ */ new Map(), F5 == null || F5({ ReactiveElement: N1 }), (M1.reactiveElementVersions ?? (M1.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const y7 = { attribute: !0, type: String, converter: a5, reflect: !1, hasChanged: L5 }, v7 = (r = y7, t, e) => {
  const { kind: o, metadata: n } = e;
  let s = globalThis.litPropertyMetadata.get(n);
  if (s === void 0 && globalThis.litPropertyMetadata.set(n, s = /* @__PURE__ */ new Map()), s.set(e.name, r), o === "accessor") {
    const { name: i } = e;
...
function k1(r) {
  return (t, e) => typeof e == "object" ? v7(r, t, e) : ((o, n, s) => {
    const i = n.hasOwnProperty(s);
    return n.constructor.createProperty(s, i ? { ...o, wrapped: !0 } : o), i ? Object.getOwnPropertyDescriptor(n, s) : void 0;
  })(r, t, e);
}
...
`;
var g7 = Object.defineProperty, f7 = Object.getOwnPropertyDescriptor, E1 = (r, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? f7(t, e) : t, s = r.length - 1, i; s >= 0; s--)
    (i = r[s]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && g7(t, e, n), n;
}, I1;
const f1 = (I1 = class extends v {
  constructor() {
    super(...arguments), this.name = "", this.label = "", this.rotate = "0", this.flip = "", this.color = "", this._size = "sm";
  }
  get size() {
  ...
  getIcon() {
    const r = p7[this.name], t = !!this.label;
    if (!r) return null;
    const e = new DOMParser().parseFromString(r, "image/svg+xml").documentElement;
    return e instanceof SVGElement ? (e.setAttribute("role", "img"), e.setAttribute("aria-label", t ? this.label : ""), e.setAttribute("aria-hidden", t ? "false" : "true"), e.style.rotate = `${this.rotate}deg`, e.style.color = this.color || "currentcolor", e.classList.add(`nys-icon--${this.size}`), e.classList.add("nys-icon--svg"), this.flip && e.classList.add(`nys-icon--flip-${this.flip}`), e) : null;
  }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const C5 = globalThis, c5 = C5.trustedTypes, W5 = c5 ? c5.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, p2 = "$lit$", t1 = `lit$${Math.random().toFixed(9).slice(2)}$`, u2 = "?" + t1, _7 = `<${u2}>`, v1 = document, h5 = () => v1.createComment(""), J1 = (r) => r === null || typeof r != "object" && typeof r != "function", M5 = Array.isArray, w7 = (r) => M5(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", u5 = `[ 	
\f\r]`, T1 = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, K5 = /-->/g, J5 = />/g, h1 = RegExp(`>|${u5}(?:([^\\s"'>=/]+)(${u5}*=${u5}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), X5 = /'/g, Q5 = /"/g, g2 = /^(?:script|style|textarea|title)$/i, X1 = Symbol.for("lit-noChange"), f = Symbol.for("lit-nothing"), t2 = /* @__PURE__ */ new WeakMap(), y1 = v1.createTreeWalker(v1, 129);
function f2(r, t) {
  if (!M5(r) || !r.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return W5 !== void 0 ? W5.createHTML(t) : t;
}
const m7 = (r, t) => {
  const e = r.length - 1, o = [];
  let n, s = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", i = T1;
  for (let C = 0; C < e; C++) {
    const c = r[C];
    let y, p, h = -1, B = 0;
    for (; B < c.length && (i.lastIndex = B, p = i.exec(c), p !== null); ) B = i.lastIndex, i === T1 ? p[1] === "!--" ? i = K5 : p[1] !== void 0 ? i = J5 : p[2] !== void 0 ? (g2.test(p[2]) && (n = RegExp("</" + p[2], "g")), i = h1) : p[3] !== void 0 && (i = h1) : i === h1 ? p[0] === ">" ? (i = n ?? T1, h = -1) : p[1] === void 0 ? h = -2 : (h = i.lastIndex - p[2].length, y = p[1], i = p[3] === void 0 ? h1 : p[3] === '"' ? Q5 : X5) : i === Q5 || i === X5 ? i = h1 : i === K5 || i === J5 ? i = T1 : (i = h1, n = void 0);
    const I = i === h1 && r[C + 1].startsWith("/>") ? " " : "";
    s += i === T1 ? c + _7 : h >= 0 ? (o.push(y), c.slice(0, h) + p2 + c.slice(h) + t1 + I) : c + t1 + (h === -2 ? C : I);
  }
  return [f2(r, s + (r[e] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), o];
};
let g5 = class b2 {
  constructor({ strings: t, _$litType$: e }, o) {
    ...
    this.parts = [];
    let s = 0, i = 0;
    const C = t.length - 1, c = this.parts, [y, p] = m7(t, e);
    ...
    for (; (n = y1.nextNode()) !== null && c.length < C; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) for (const h of n.getAttributeNames()) if (h.endsWith(p2)) {
          const B = p[i++], I = n.getAttribute(h).split(t1), t5 = /([.?@])?(.*)/.exec(B);
          c.push({ type: 1, index: s, name: t5[2], strings: I, ctor: t5[1] === "." ? L7 : t5[1] === "?" ? M7 : t5[1] === "@" ? $7 : v5 }), n.removeAttribute(h);
        } else h.startsWith(t1) && (c.push({ type: 6, index: s }), n.removeAttribute(h));
        if (g2.test(n.tagName)) {
          const h = n.textContent.split(t1), B = h.length - 1;
          if (B > 0) {
            n.textContent = c5 ? c5.emptyScript : "";
            for (let I = 0; I < B; I++) n.append(h[I], h5()), y1.nextNode(), c.push({ type: 2, index: ++s });
            n.append(h[B], h5());
          }
        }
      } else if (n.nodeType === 8) if (n.data === u2) c.push({ type: 2, index: s });
      else {
        let h = -1;
        for (; (h = n.data.indexOf(t1, h + 1)) !== -1; ) c.push({ type: 7, index: s }), h += t1.length - 1;
      }
      s++;
    }
  }
  static createElement(t, e) {
    const o = v1.createElement("template");
    return o.innerHTML = t, o;
  }
};
function $1(r, t, e = r, o) {
  var n, s;
  if (t === X1) return t;
  let i = o !== void 0 ? (n = e._$Co) == null ? void 0 : n[o] : e._$Cl;
  const C = J1(t) ? void 0 : t._$litDirective$;
  return (i == null ? void 0 : i.constructor) !== C && ((s = i == null ? void 0 : i._$AO) == null || s.call(i, !1), C === void 0 ? i = void 0 : (i = new C(r), i._$AT(r, e, o)), o !== void 0 ? (e._$Co ?? (e._$Co = []))[o] = i : e._$Cl = i), i !== void 0 && (t = $1(r, i._$AS(r, t.values), i, o)), t;
}
class x7 {
  constructor(t, e) {
  ...
  u(t) {
    const { el: { content: e }, parts: o } = this._$AD, n = ((t == null ? void 0 : t.creationScope) ?? v1).importNode(e, !0);
    y1.currentNode = n;
    let s = y1.nextNode(), i = 0, C = 0, c = o[0];
    for (; c !== void 0; ) {
      if (i === c.index) {
        let y;
        c.type === 2 ? y = new _2(s, s.nextSibling, this, t) : c.type === 1 ? y = new c.ctor(s, c.name, c.strings, this, t) : c.type === 6 && (y = new Z7(s, this, t)), this._$AV.push(y), c = o[++C];
      }
      i !== (c == null ? void 0 : c.index) && (s = y1.nextNode(), i++);
    }
    return y1.currentNode = v1, n;
  }
  p(t) {
    let e = 0;
...
let _2 = class w2 {
  ...
  _(t) {
    this._$AH !== f && J1(this._$AH) ? this._$AA.nextSibling.data = t : this.T(v1.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var e;
    const { values: o, _$litType$: n } = t, s = typeof n == "number" ? this._$AC(t) : (n.el === void 0 && (n.el = g5.createElement(f2(n.h, n.h[0]), this.options)), n);
    if (((e = this._$AH) == null ? void 0 : e._$AD) === s) this._$AH.p(o);
    else {
      const i = new x7(s, this), C = i.u(this.options);
  ...
  k(t) {
    ...
    const e = this._$AH;
    let o, n = 0;
    for (const s of t) n === e.length ? e.push(o = new w2(this.O(h5()), this.O(h5()), this, this.options)) : o = e[n], o._$AI(s), n++;
  ...
  _$AI(t, e = this, o, n) {
    ...
    let i = !1;
    if (s === void 0) t = $1(this, t, e, 0), i = !J1(t) || t !== this._$AH && t !== X1, i && (this._$AH = t);
    else {
      const C = t;
      let c, y;
      for (t = s[0], c = 0; c < s.length - 1; c++) y = $1(this, C[o + c], e, c), y === X1 && (y = this._$AH[c]), i || (i = !J1(y) || y !== this._$AH[c]), y === f ? t = f : t !== f && (t += (y ?? "") + s[c + 1]), this._$AH[c] = y;
    }
    i && !n && this.j(t);
  }
  j(t) {
 ...
 */
const Q = (r) => r ?? f;
var H7 = Object.defineProperty, V7 = Object.getOwnPropertyDescriptor, V = (r, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? V7(t, e) : t, s = r.length - 1, i; s >= 0; s--)
    (i = r[s]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && H7(t, e, n), n;
};
let S7 = 0;
var Y;
const M = (Y = class extends v {
  constructor() {
  ...
  set variant(r) {
    this._variant = Y.VALID_VARIANTS.includes(
      r
    ) ? r : "filled";
  }
  get type() {
  ...
  set type(r) {
    this._type = Y.VALID_TYPES.includes(
      r
    ) ? r : "button";
  }
  /**************** Lifecycle Methods ****************/
...
}, Y.VALID_SIZES = ["sm", "md", "lg"], Y.VALID_VARIANTS = [
  "filled",
  "outline",
  "ghost",
  "text"
], Y.VALID_TYPES = ["submit", "reset", "button"], Y.styles = o7, Y);
V([
  H({ type: String })
], M.prototype, "id", 2);
V([
...
var E7 = Object.defineProperty, z7 = Object.getOwnPropertyDescriptor, E = (r, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? z7(t, e) : t, s = r.length - 1, i; s >= 0; s--)
    (i = r[s]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && E7(t, e, n), n;
};
let A7 = 0;
var e1;
const k = (e1 = class extends v {
  constructor() {
  ...
  _checkSlotContent() {
    ...
    if (t) {
      const o = t.assignedNodes({ flatten: !0 }).filter(
        (n) => {
          var s;
          return n.nodeType === Node.ELEMENT_NODE || n.nodeType === Node.TEXT_NODE && ((s = n.textContent) == null ? void 0 : s.trim());
        }
      );
...
`;
var O7 = Object.defineProperty, U7 = Object.getOwnPropertyDescriptor, C1 = (r, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? U7(t, e) : t, s = r.length - 1, i; s >= 0; s--)
    (i = r[s]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && O7(t, e, n), n;
};
let D7 = 0;
var o1;
const K = (o1 = class extends v {
  constructor() {
...
let N7 = K;
customElements.get("nys-avatar") || customElements.define("nys-avatar", N7);
const I7 = b`
  :host {
    /* Anything that can be overridden should be defined here */
...
`;
var T7 = Object.defineProperty, R7 = Object.getOwnPropertyDescriptor, S = (r, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? R7(t, e) : t, s = r.length - 1, i; s >= 0; s--)
    (i = r[s]) && (n = (o ? i(t, e, n) : i(n)) || n);
...
const $ = (z = class extends v {
  ...
  "ghost",
  "text"
], z.VALID_TYPES = ["submit", "reset", "button"], z.styles = I7, z);
S([
  l({ type: String })
], $.prototype, "id", 2);
S([
...
`;
var G7 = Object.defineProperty, F7 = Object.getOwnPropertyDescriptor, c1 = (r, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? F7(t, e) : t, s = r.length - 1, i; s >= 0; s--)
    (i = r[s]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && G7(t, e, n), n;
};
...
const J = (n1 = class extends v {
  ...
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-checkbox-${Date.now()}-${Y7++}`);
  }
  updated(t) {
...
let W7 = J;
customElements.get("nys-checkboxgroup") || customElements.define("nys-checkboxgroup", W7);
var K7 = Object.defineProperty, J7 = Object.getOwnPropertyDescriptor, O = (r, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? J7(t, e) : t, s = r.length - 1, i; s >= 0; s--)
    (i = r[s]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && K7(t, e, n), n;
};
let X7 = 0;
var r1;
const A = (r1 = class extends v {
  constructor() {
  ...
  set size(t) {
    this._size = r1.VALID_SIZES.includes(
      t
    ) ? t : "md";
  }
  // Generate a unique ID if one is not provided
...
}, r1.VALID_SIZES = ["sm", "md"], r1.styles = m2, r1);
O([
  l({ type: Boolean })
...
`;
var o3 = Object.defineProperty, n3 = Object.getOwnPropertyDescriptor, z1 = (r, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? n3(t, e) : t, s = r.length - 1, i; s >= 0; s--)
    (i = r[s]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && o3(t, e, n), n;
}, s1;
const b1 = (s1 = class extends v {
  constructor() {
    super(...arguments), this.name = "", this.label = "", this.rotate = "0", this.flip = "", this.color = "", this._size = "sm";
  }
  get size() {
  ...
  set size(t) {
    this._size = s1.VALID_TYPES.includes(
      t
    ) ? t : "sm";
  }
  getIcon() {
    ...
    return s instanceof SVGElement ? (s.setAttribute("role", "img"), s.setAttribute("aria-label", e ? this.label : ""), s.setAttribute("aria-hidden", e ? "false" : "true"), s.style.rotate = `${this.rotate}deg`, s.style.color = this.color || "currentcolor", s.classList.add(`nys-icon--${this.size}`), s.classList.add("nys-icon--svg"), this.flip && s.classList.add(`nys-icon--flip-${this.flip}`), s) : null;
  }
  render() {
    const t = this.getIcon();
    return t ? a`${t}` : null;
  }
}, s1.styles = e3, s1.VALID_TYPES = [
  "2xs",
  "xs",
  "sm",
  "md",
...
let r3 = b1;
customElements.get("nys-icon") || customElements.define("nys-icon", r3);
const x2 = b`
  :host {
...
`;
var s3 = Object.defineProperty, i3 = Object.getOwnPropertyDescriptor, j = (r, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? i3(t, e) : t, s = r.length - 1, i; s >= 0; s--)
    (i = r[s]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && s3(t, e, n), n;
};
let l3 = 0;
var i1;
const U = (i1 = class extends v {
  constructor() {
...
var C3 = Object.defineProperty, c3 = Object.getOwnPropertyDescriptor, X = (r, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? c3(t, e) : t, s = r.length - 1, i; s >= 0; s--)
    (i = r[s]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && C3(t, e, n), n;
};
let h3 = 0;
var d;
const G = (d = class extends v {
  constructor() {
...
`;
var v3 = Object.defineProperty, Q1 = (r, t, e, o) => {
  for (var n = void 0, s = r.length - 1, i; s >= 0; s--)
    (i = r[s]) && (n = i(t, e, n) || n);
  return n && v3(t, e, n), n;
};
class _1 extends v {
...
var p3 = Object.defineProperty, u3 = Object.getOwnPropertyDescriptor, D = (r, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? u3(t, e) : t, s = r.length - 1, i; s >= 0; s--)
    (i = r[s]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && p3(t, e, n), n;
}, l1;
const P = (l1 = class extends v {
  constructor() {
  ...
  _handleSlotChange() {
    ...
    if (t) {
      const n = t.assignedElements({ flatten: !0 }), s = (o = this.shadowRoot) == null ? void 0 : o.querySelector("select");
      s && n.forEach((i) => {
        var C;
        if (i instanceof _1) {
          const c = document.createElement("option");
          c.value = i.value, c.textContent = i.label || ((C = i.textContent) == null ? void 0 : C.trim()) || "", c.disabled = i.disabled, c.selected = i.selected, s.appendChild(c);
        }
      });
    }
  }
...
`;
var b3 = Object.defineProperty, _3 = Object.getOwnPropertyDescriptor, Z = (r, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? _3(t, e) : t, s = r.length - 1, i; s >= 0; s--)
    (i = r[s]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && b3(t, e, n), n;
}, T;
const x = (T = class extends v {
  constructor() {
...
`;
var x3 = Object.defineProperty, L3 = Object.getOwnPropertyDescriptor, _ = (r, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? L3(t, e) : t, s = r.length - 1, i; s >= 0; s--)
    (i = r[s]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && x3(t, e, n), n;
}, R;
const u = (R = class extends v {
  constructor() {
...
`;
var Z3 = Object.defineProperty, H3 = Object.getOwnPropertyDescriptor, F = (r, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? H3(t, e) : t, s = r.length - 1, i; s >= 0; s--)
    (i = r[s]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && Z3(t, e, n), n;
};
let V3 = 0;
var a1;
const N = (a1 = class extends v {
  constructor() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const r5 = globalThis, $5 = r5.ShadowRoot && (r5.ShadyCSS === void 0 || r5.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, L2 = Symbol(), o2 = /* @__PURE__ */ new WeakMap();
let z3 = class {
  constructor(r, t, e) {
  ...
  get styleSheet() {
    ...
    if ($5 && r === void 0) {
      const e = t !== void 0 && t.length === 1;
      e && (r = o2.get(t)), r === void 0 && ((this.o = r = new CSSStyleSheet()).replaceSync(this.cssText), e && o2.set(t, r));
    }
    return r;
  }
  toString() {
...
const A3 = (r) => new z3(typeof r == "string" ? r : r + "", void 0, L2), P3 = (r, t) => {
  if ($5) r.adoptedStyleSheets = t.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet);
  else for (const e of t) {
    const o = document.createElement("style"), n = r5.litNonce;
    n !== void 0 && o.setAttribute("nonce", n), o.textContent = e.cssText, r.appendChild(o);
  }
}, n2 = $5 ? (r) => r : (r) => r instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const o of t.cssRules) e += o.cssText;
  return A3(e);
})(r) : r;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: B3, defineProperty: O3, getOwnPropertyDescriptor: U3, getOwnPropertyNames: D3, getOwnPropertySymbols: N3, getPrototypeOf: I3 } = Object, Z1 = globalThis, r2 = Z1.trustedTypes, T3 = r2 ? r2.emptyScript : "", s2 = Z1.reactiveElementPolyfillSupport, W1 = (r, t) => r, d5 = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? T3 : null;
      break;
  ...
  return e;
} }, Z5 = (r, t) => !B3(r, t), i2 = { attribute: !0, type: String, converter: d5, reflect: !1, hasChanged: Z5 };
...
class R1 extends HTMLElement {
  ...
  static getPropertyDescriptor(t, e, o) {
    const { get: n, set: s } = U3(this.prototype, t) ?? { get() {
      return this[e];
    }, set(i) {
      this[e] = i;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(W1("properties"))) {
      const e = this.properties, o = [...D3(e), ...N3(e)];
      for (const n of o) this.createProperty(n, e[n]);
    }
    const t = this[Symbol.metadata];
    if (t !== null) {
  ...
  _$AK(t, e) {
    ...
    const n = this.constructor, s = n._$Eh.get(t);
    if (s !== void 0 && this._$Em !== s) {
      const i = n.getPropertyOptions(s), C = typeof i.converter == "function" ? { fromAttribute: i.converter } : ((o = i.converter) == null ? void 0 : o.fromAttribute) !== void 0 ? i.converter : d5;
      this._$Em = s, this[s] = C.fromAttribute(e, i.type), this._$Em = null;
    }
  }
  requestUpdate(t, e, o) {
...
R1.elementStyles = [], R1.shadowRootOptions = { mode: "open" }, R1[W1("elementProperties")] = /* @__PURE__ */ new Map(), R1[W1("finalized")] = /* @__PURE__ */ new Map(), s2 == null || s2({ ReactiveElement: R1 }), (Z1.reactiveElementVersions ?? (Z1.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const R3 = { attribute: !0, type: String, converter: d5, reflect: !1, hasChanged: Z5 }, q3 = (r = R3, t, e) => {
  const { kind: o, metadata: n } = e;
  let s = globalThis.litPropertyMetadata.get(n);
  if (s === void 0 && globalThis.litPropertyMetadata.set(n, s = /* @__PURE__ */ new Map()), s.set(e.name, r), o === "accessor") {
    const { name: i } = e;
...
function w(r) {
  return (t, e) => typeof e == "object" ? q3(r, t, e) : ((o, n, s) => {
    const i = n.hasOwnProperty(s);
    return n.constructor.createProperty(s, i ? { ...o, wrapped: !0 } : o), i ? Object.getOwnPropertyDescriptor(n, s) : void 0;
  })(r, t, e);
}
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const s5 = globalThis, H5 = s5.ShadowRoot && (s5.ShadyCSS === void 0 || s5.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, M2 = Symbol(), l2 = /* @__PURE__ */ new WeakMap();
let G3 = class {
  constructor(r, t, e) {
  ...
  get styleSheet() {
    ...
    if (H5 && r === void 0) {
      const e = t !== void 0 && t.length === 1;
      e && (r = l2.get(t)), r === void 0 && ((this.o = r = new CSSStyleSheet()).replaceSync(this.cssText), e && l2.set(t, r));
    }
    return r;
  }
  toString() {
...
const F3 = (r) => new G3(typeof r == "string" ? r : r + "", void 0, M2), Y3 = (r, t) => {
  if (H5) r.adoptedStyleSheets = t.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet);
  else for (const e of t) {
    const o = document.createElement("style"), n = s5.litNonce;
    n !== void 0 && o.setAttribute("nonce", n), o.textContent = e.cssText, r.appendChild(o);
  }
}, a2 = H5 ? (r) => r : (r) => r instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const o of t.cssRules) e += o.cssText;
  return F3(e);
})(r) : r;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: W3, defineProperty: K3, getOwnPropertyDescriptor: J3, getOwnPropertyNames: X3, getOwnPropertySymbols: Q3, getPrototypeOf: t0 } = Object, H1 = globalThis, C2 = H1.trustedTypes, e0 = C2 ? C2.emptyScript : "", c2 = H1.reactiveElementPolyfillSupport, K1 = (r, t) => r, y5 = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? e0 : null;
      break;
  ...
  return e;
} }, V5 = (r, t) => !W3(r, t), h2 = { attribute: !0, type: String, converter: y5, reflect: !1, hasChanged: V5 };
...
class q1 extends HTMLElement {
  ...
  static getPropertyDescriptor(t, e, o) {
    const { get: n, set: s } = J3(this.prototype, t) ?? { get() {
      return this[e];
    }, set(i) {
      this[e] = i;
    } };
  ...
  createRenderRoot() {
    const t = this.shadowRoot ?? this.attachShadow(this.constructor.shadowRootOptions);
    return Y3(t, this.constructor.elementStyles), t;
  }
  connectedCallback() {
    var t;
    this.renderRoot ?? (this.renderRoot = this.createRenderRoot()), this.enableUpdating(!0), (t = this._$EO) == null || t.forEach((e) => {
  ...
  _$AK(t, e) {
    ...
    const n = this.constructor, s = n._$Eh.get(t);
    if (s !== void 0 && this._$Em !== s) {
      const i = n.getPropertyOptions(s), C = typeof i.converter == "function" ? { fromAttribute: i.converter } : ((o = i.converter) == null ? void 0 : o.fromAttribute) !== void 0 ? i.converter : y5;
      this._$Em = s, this[s] = C.fromAttribute(e, i.type), this._$Em = null;
    }
  }
  requestUpdate(t, e, o) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const o0 = { attribute: !0, type: String, converter: y5, reflect: !1, hasChanged: V5 }, n0 = (r = o0, t, e) => {
  const { kind: o, metadata: n } = e;
  let s = globalThis.litPropertyMetadata.get(n);
  if (s === void 0 && globalThis.litPropertyMetadata.set(n, s = /* @__PURE__ */ new Map()), s.set(e.name, r), o === "accessor") {
    const { name: i } = e;
...
function A1(r) {
  return (t, e) => typeof e == "object" ? n0(r, t, e) : ((o, n, s) => {
    const i = n.hasOwnProperty(s);
    return n.constructor.createProperty(s, i ? { ...o, wrapped: !0 } : o), i ? Object.getOwnPropertyDescriptor(n, s) : void 0;
  })(r, t, e);
}
...
`;
var i0 = Object.defineProperty, l0 = Object.getOwnPropertyDescriptor, P1 = (r, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? l0(t, e) : t, s = r.length - 1, i; s >= 0; s--)
    (i = r[s]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && i0(t, e, n), n;
}, j1;
const w1 = (j1 = class extends v {
  constructor() {
    super(...arguments), this.name = "", this.label = "", this.rotate = "0", this.flip = "", this.color = "", this._size = "sm";
  }
  get size() {
  ...
  getIcon() {
    const r = r0[this.name], t = !!this.label;
    if (!r) return null;
    const e = new DOMParser().parseFromString(r, "image/svg+xml").documentElement;
    return e instanceof SVGElement ? (e.setAttribute("role", "img"), e.setAttribute("aria-label", t ? this.label : ""), e.setAttribute("aria-hidden", t ? "false" : "true"), e.style.rotate = `${this.rotate}deg`, e.style.color = this.color || "currentcolor", e.classList.add(`nys-icon--${this.size}`), e.classList.add("nys-icon--svg"), this.flip && e.classList.add(`nys-icon--flip-${this.flip}`), e) : null;
  }
...
var C0 = Object.defineProperty, c0 = Object.getOwnPropertyDescriptor, m = (r, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? c0(t, e) : t, s = r.length - 1, i; s >= 0; s--)
    (i = r[s]) && (n = (o ? i(t, e, n) : i(n)) || n);
  return o && n && C0(t, e, n), n;
}, d1;
const g = (d1 = class extends v {
  constructor() {
    super(), this.id = "", this.name = "", this._type = "text", this.label = "", this.description = "", this.placeholder = "", this.value = "", this.disabled = !1, this.readonly = !1, this.required = !1, this.form = "", this.pattern = "", this.maxlength = null, this.width = "full", this.step = null, this.min = null, this.max = null, this.showError = !1, this.errorMessage = "";
  }
  get type() {
  ...
  // Ensure the "width" property is valid after updates
  updated(r) {
    r.has("width") && (this.width = d1.VALID_WIDTHS.includes(this.width) ? this.width : "full");
  }
  // Handle input event to check pattern validity
  _handleInput(r) {
    const t = r.target;
...
var d0 = Object.defineProperty, y0 = Object.getOwnPropertyDescriptor, m1 = (r, t, e, o) => {
  for (var n = o > 1 ? void 0 : o ? y0(t, e) : t, s = r.length - 1, i; s >= 0; s--)
    (i = r[s]) && (n = (o ? i(t, e, n) : i(n)) || n);
...
`;
var p0 = Object.defineProperty, B1 = (r, t, e, o) => {
  for (var n = void 0, s = r.length - 1, i; s >= 0; s--)
    (i = r[s]) && (n = i(t, e, n) || n);
  return n && p0(t, e, n), n;
};
const k5 = class k5 extends v {
  constructor() {
  ...
  _handleSlotChange() {
    ...
    o && n && (o.innerHTML = "", n.innerHTML = "", e.forEach((c) => {
      if (c.nodeType === Node.ELEMENT_NODE) {
        const y = c.cloneNode(!0), p = c.cloneNode(!0);
        ["script", "iframe", "object", "embed"].forEach((B) => {
          y.querySelectorAll(B).forEach((I) => I.remove());
        }), o.appendChild(y), n.appendChild(p), c.remove();
      }
    }));
  }
  _toggleMobileMenu() {
...
B1([
  l({ type: String })
], W.prototype, "agencyName");
B1([
  l({ type: String })
], W.prototype, "homepageLink");
B1([
  l({ type: Boolean })
], W.prototype, "disableHomepageLink");
B1([
  u1()
], W.prototype, "slotHasContent");
B1([
  u1()
], W.prototype, "isMobileMenuOpen");
customElements.get("nys-globalheader") || customElements.define("nys-globalheader", W);
const u0 = b`
  :host {
...
`;
var g0 = Object.defineProperty, p5 = (r, t, e, o) => {
  for (var n = void 0, s = r.length - 1, i; s >= 0; s--)
    (i = r[s]) && (n = i(t, e, n) || n);
  return n && g0(t, e, n), n;
};
  ...
  _handleSlotChange() {
    ...
    o && (o.classList.toggle("columns", n), o.classList.toggle("small", !n), o.innerHTML = "", e.forEach((C) => {
      if (C.nodeType === Node.ELEMENT_NODE) {
        ...
        ["script", "iframe", "object", "embed"].forEach((p) => {
          c.querySelectorAll(p).forEach((h) => h.remove());
...
p5([
  l({ type: Boolean })
], p1.prototype, "disableHomepageLink");
p5([
  u1()
], p1.prototype, "slotHasContent");
customElements.get("nys-globalfooter") || customElements.define("nys-globalfooter", p1);
const f0 = b`
  :host {
    /* Global Footer Styles */
...
export {
  ...
  j7 as NysButton,
  Q7 as NysCheckbox,
  p1 as NysGlobalFooter,
  W as NysGlobalHeader,
  r3 as NysIcon,
